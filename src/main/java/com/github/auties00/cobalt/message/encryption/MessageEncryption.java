...
public final class MessageEncryption {
     ...
     * @throws WhatsAppMessageException.Send if encryption fails
     */
    public MessageEncryptedPayload encryptForGroup(Jid groupJid, Jid senderJid, MessageContainer container) {
        Objects.requireNonNull(container, "container cannot be null");
        var plaintext = MessageContainerSpec.encode(container);
        return encryptForGroup(groupJid, senderJid, plaintext);
    }
