...
/**
 * Bot capability types advertised in BotCapabilityMetadata.
 * <p>
 * These capabilities tell the server what rich response features
 * the client supports. Without advertising capabilities, the server
 * will not send rich/structured responses.
 *
 * @apiNote WAWebProtobufsAICommon.pb.BotCapabilityMetadata$BotCapabilityType
 */
@ProtobufEnum
public enum BotCapabilityType {
    UNKNOWN(0),
