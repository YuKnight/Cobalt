...
public final class DeviceInfo {
    ...
    /**
     * Explicit hosted flag from is_hosted attribute.
     *
     * @apiNote WAWebDBDeviceListFanout.getFanOutList: checks both {@code e.id === 99 || e.isHosted === true}
     * to determine if a device is hosted. This flag captures the is_hosted attribute independently.
     */
