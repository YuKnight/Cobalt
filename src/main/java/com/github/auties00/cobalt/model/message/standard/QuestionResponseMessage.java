...
/**
 * A model class that represents a question response message.
 */
...
public final class QuestionResponseMessage implements Message {
    ...
    QuestionResponseMessage(ChatMessageKey key, String text) {
        this.key = key;
        this.text = text;
    }
    ...
    public boolean equals(Object o) {
        return o instanceof QuestionResponseMessage that
    ...
    public String toString() {
        return "QuestionResponseMessage[text=" + text + ']';
    }
}
