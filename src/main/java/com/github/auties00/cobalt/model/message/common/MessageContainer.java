...
public final class MessageContainer {
    ...
    /**
     * Wraps a message container in a botInvokeMessage wrapper.
     * <p>
     * Used when sending messages to PN bots or for bot_request_welcome messages.
     * The inner message is wrapped in a FutureMessageContainer at protobuf index 67.
     *
     * @param inner the message container to wrap
     * @return a new message container with the botInvokeMessage field set
     * @apiNote WAWebE2EProtoGenerator function v (botInvokeMessage wrapper)
     */
    public static MessageContainer ofBotInvoke(MessageContainer inner) {
        var futureMessageContainer = new FutureMessageContainerBuilder()
                .value(inner)
                .build();
        return new MessageContainerBuilder()
    ...
    public Optional<FutureMessageContainer> botInvokeMessage() {
