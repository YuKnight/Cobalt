...
public final class DeviceList {
    ...
    @ProtobufProperty(index = 3, type = ProtobufType.UINT64, mixins = InstantProtobufMixin.class)
    ...
    @ProtobufProperty(index = 9, type = ProtobufType.UINT64, mixins = InstantProtobufMixin.class)
    final Instant expectedTimestamp;

    @ProtobufProperty(index = 10, type = ProtobufType.UINT64, mixins = InstantProtobufMixin.class)
    final Instant expectedTimestampLastDeviceJobTimestamp;

    @ProtobufProperty(index = 11, type = ProtobufType.UINT64, mixins = InstantProtobufMixin.class)
