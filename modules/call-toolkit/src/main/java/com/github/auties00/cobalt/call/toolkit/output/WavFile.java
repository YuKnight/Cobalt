 ...
 * {@link com.github.auties00.cobalt.call.toolkit.output.CallRecorder}.
 */
public final class WavFile implements AudioSink, AutoCloseable {
    /**
    ...
    public void write(AudioFrame frame) {
        ...
        if (closed) {
            throw new IllegalStateException("WavFile already closed");
        }
        var pcm = frame.pcm();
