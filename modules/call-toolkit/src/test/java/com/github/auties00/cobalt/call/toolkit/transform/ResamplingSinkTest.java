...
class ResamplingSinkTest {
    ...
    void passThroughWhenRatesMatch() throws InterruptedException {
        ...
        var sink = new ResamplingSink(downstream, 16_000, 16_000);
    ...
    void downsample16To8() throws InterruptedException {
        var captured = new ArrayList<AudioFrame>();
        AudioSink downstream = captured::add;
        var sink = new ResamplingSink(downstream, 16_000, 8_000);
    ...
    void rejectsBadArgs() {
        ...
        assertThrows(NullPointerException.class, () -> new ResamplingSink(null, 16_000, 8_000));
        assertThrows(IllegalArgumentException.class, () -> new ResamplingSink(any, 0, 8_000));
        assertThrows(IllegalArgumentException.class, () -> new ResamplingSink(any, 16_000, 0));
    }
}
