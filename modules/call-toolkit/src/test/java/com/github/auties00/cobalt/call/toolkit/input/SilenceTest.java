...
class SilenceTest {
    ...
    @Test
    void rejectsBadArgs() {
        assertThrows(IllegalArgumentException.class, () -> new Silence(0, 10));
        assertThrows(IllegalArgumentException.class, () -> new Silence(160, 0));
    }
}
