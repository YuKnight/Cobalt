...
class ToneTest {
    ...
    void dtmfDigits() {
        ...
        assertThrows(IllegalArgumentException.class, () -> Tone.dtmf('Z'));
    }
    ...
    void rejectsBadArgs() {
        assertThrows(IllegalArgumentException.class,
                () -> new Tone(0, 0, 1, 1, 160, 10));
        assertThrows(IllegalArgumentException.class,
                () -> new Tone(440, -1, 1, 1, 160, 10));
        assertThrows(IllegalArgumentException.class,
                () -> new Tone(440, 0, 0, 1, 160, 10));
        assertThrows(IllegalArgumentException.class,
                () -> new Tone(440, 0, 5, 4, 160, 10));
        assertThrows(IllegalArgumentException.class,
                () -> new Tone(440, 0, 1, 1, 0, 10));
        assertThrows(IllegalArgumentException.class,
                () -> new Tone(440, 0, 1, 1, 160, 0));
    }
