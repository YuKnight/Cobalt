 ...
 * them.
 *
 * <p>Unlike {@link WhatsAppClientDeviceAttestor}, this interface is not sealed
 ...
 */
public interface WhatsAppClientDevicePushClient extends AutoCloseable {
    /**
     * Returns a fresh, unauthenticated APNS-backed push client.
     *
     * <p>The caller must drive {@link #authenticate(WhatsAppClientDevice)} with
     * an iOS or iOS-business device before any read-only accessor becomes
     * usable.
     *
     * @return a new unauthenticated APNS-backed push client
     */
    static WhatsAppClientDevicePushClient apns() {
     ...
     */
    static WhatsAppClientDevicePushClient fcm() {
     ...
     */
    static WhatsAppClientDevicePushClient noop() {
     ...
     *
     * @apiNote
     * Consult this before {@link #authenticate(WhatsAppClientDevice)} to verify
     ...
     */
    void authenticate(WhatsAppClientDevice device);
     ...
     *
     * @apiNote
     * Consult this to decide whether {@link #authenticate(WhatsAppClientDevice)}
