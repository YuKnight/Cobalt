 ...
 * {@link BizAiLeadGenFormsWhatsAppWebGraphQlRequest} into a list of {@link BusinessAiLeadGenForm}.
 *
 ...
 * domain shape.
 *
 * @see BizAiLeadGenFormsWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizAiLeadGenFormsQuery")
public final class BizAiLeadGenFormsWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private BizAiLeadGenFormsWhatsAppWebGraphQlResponse(List<BusinessAiLeadGenForm> forms) {
        this.forms = forms;
    }
     ...
     */
    public static Optional<BizAiLeadGenFormsWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
            return Optional.empty();
        }

        var forms = parseForms(data.getJSONArray("xfb_maiba_gen_lead_gen_flow"));
        return Optional.of(new BizAiLeadGenFormsWhatsAppWebGraphQlResponse(forms));
    }
