 ...
 * {@link BizGetCustomUrlUserGraphqlWhatsAppWebGraphQlRequest} into a {@link BusinessCustomUrlIdentity}.
 *
 ...
 *
 * @see BizGetCustomUrlUserGraphqlWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizGetCustomUrlUserGraphqlQuery")
public final class BizGetCustomUrlUserGraphqlWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private BizGetCustomUrlUserGraphqlWhatsAppWebGraphQlResponse(BusinessCustomUrlIdentity identity) {
    ...
    public static Optional<BizGetCustomUrlUserGraphqlWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        var identity = new BusinessCustomUrlIdentityBuilder()
                ...
                .build();
        return Optional.of(new BizGetCustomUrlUserGraphqlWhatsAppWebGraphQlResponse(identity));
    }
