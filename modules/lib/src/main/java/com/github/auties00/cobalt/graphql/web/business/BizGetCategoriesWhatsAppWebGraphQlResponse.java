 ...
 * {@link BizGetCategoriesWhatsAppWebGraphQlRequest} into a flat list of {@link BusinessCategory}.
 *
 ...
 *
 * @see BizGetCategoriesWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizGetCategoriesQuery")
public final class BizGetCategoriesWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private BizGetCategoriesWhatsAppWebGraphQlResponse(List<BusinessCategory> categories) {
    ...
    public static Optional<BizGetCategoriesWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        return Optional.of(new BizGetCategoriesWhatsAppWebGraphQlResponse(categories));
    }
