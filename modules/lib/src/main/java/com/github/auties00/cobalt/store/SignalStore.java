...
public interface SignalStore extends SignalProtocolStore {
    /**
     ...
     */
    SignalStore setSignedDeviceIdentity(ADVSignedDeviceIdentity identity);
     ...
     * @return this store instance for method chaining
     */
    SignalStore setAdvSecretKey(byte[] key);
