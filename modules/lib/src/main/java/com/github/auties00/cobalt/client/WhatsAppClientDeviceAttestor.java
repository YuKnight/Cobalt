 ...
 * are produced separately by {@link WhatsAppClientDevicePushClient}, which is
 ...
 */
public sealed interface WhatsAppClientDeviceAttestor
        permits WhatsAppClientDeviceAttestor.Android, WhatsAppClientDeviceAttestor.Ios {
     ...
     */
    non-sealed interface Android extends WhatsAppClientDeviceAttestor {
        /**
     ...
     */
    non-sealed interface Ios extends WhatsAppClientDeviceAttestor {
        /**
