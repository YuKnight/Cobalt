 ...
 * {@link BizCatalogManagementCreateCatalogWhatsAppWebGraphQlResponse}.
 *
 * @see BizCatalogManagementCreateCatalogWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizCatalogManagementCreateCatalogMutation")
public final class BizCatalogManagementCreateCatalogWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public BizCatalogManagementCreateCatalogWhatsAppWebGraphQlRequest(Jid bizJid, String platform) {
        this.bizJid = bizJid;
