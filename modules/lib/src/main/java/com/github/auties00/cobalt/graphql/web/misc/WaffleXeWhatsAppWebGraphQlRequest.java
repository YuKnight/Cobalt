 ...
 * through {@link WaffleXeWhatsAppWebGraphQlResponse}.
 *
 * @see WaffleXeWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebWaffleXEQuery")
public final class WaffleXeWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public WaffleXeWhatsAppWebGraphQlRequest(List<Instant> expirationTimes, String purposeClientPublicKey, List<String> uniqueIds, List<WaffleXas> destinations, String sessionId) {
