 ...
 * {@link ResolveAccountTypeAndAdPageMutationWhatsAppWebGraphQlRequest} into a
 ...
 *
 * @see ResolveAccountTypeAndAdPageMutationWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebResolveAccountTypeAndAdPageMutation")
public final class ResolveAccountTypeAndAdPageMutationWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private ResolveAccountTypeAndAdPageMutationWhatsAppWebGraphQlResponse(WhatsAppAdsAccountTypeReset reset) {
        this.reset = reset;
    }
     ...
     */
    public static Optional<ResolveAccountTypeAndAdPageMutationWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        var reset = new WhatsAppAdsAccountTypeResetBuilder()
                ...
                .build();
        return Optional.of(new ResolveAccountTypeAndAdPageMutationWhatsAppWebGraphQlResponse(reset));
    }
