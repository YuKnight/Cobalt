...
public final class FetchNewsletterAdminCapabilitiesMexRequest implements MexOperation.Request.Json {
     ...
     * {@code params.name} value of the compiled mexFetchNewsletterAdminCapabilities
     * operation.
     *
     ...
     *
     * @implNote WAWebMexFetchNewsletterAdminCapabilitiesJob: WA Web invokes the operation through
     ...
     * scalar verbatim as {@code "mexFetchNewsletterAdminCapabilities"}.
     */
     ...
     * {@link #QUERY_ID}.
     *
     * @implNote WAWebMexFetchNewsletterAdminCapabilitiesJob: WA Web reads the {@code params.id}
     ...
     * {@link #OPERATION_NAME}.
     *
     * @implNote WAWebMexFetchNewsletterAdminCapabilitiesJob: WA Web's
