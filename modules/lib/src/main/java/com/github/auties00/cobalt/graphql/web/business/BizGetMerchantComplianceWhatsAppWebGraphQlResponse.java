 ...
 * {@link BizGetMerchantComplianceWhatsAppWebGraphQlRequest}.
 *
 ...
 *
 * @see BizGetMerchantComplianceWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizGetMerchantComplianceQuery")
public final class BizGetMerchantComplianceWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private BizGetMerchantComplianceWhatsAppWebGraphQlResponse(MerchantInfo merchantInfo) {
     ...
     */
    public static Optional<BizGetMerchantComplianceWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        return Optional.of(new BizGetMerchantComplianceWhatsAppWebGraphQlResponse(merchantInfo));
    }
    ...
    public static final class MerchantInfo {
         ...
         *
         * <p>Used by {@link BizGetMerchantComplianceWhatsAppWebGraphQlResponse#of(JSONObject)} to hydrate the
