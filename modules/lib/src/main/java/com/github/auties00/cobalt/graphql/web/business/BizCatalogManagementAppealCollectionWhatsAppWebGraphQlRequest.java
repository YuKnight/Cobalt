 ...
 * the reply is consumed through {@link BizCatalogManagementAppealCollectionWhatsAppWebGraphQlResponse}.
 *
 * @see BizCatalogManagementAppealCollectionWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizCatalogManagementAppealCollectionMutation")
public final class BizCatalogManagementAppealCollectionWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public BizCatalogManagementAppealCollectionWhatsAppWebGraphQlRequest(String productSetId, Jid jid, String reason) {
