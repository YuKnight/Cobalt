 ...
 * reply is consumed through {@link BizCatalogManagementFetchProductListWhatsAppWebGraphQlResponse}.
 *
 * @see BizCatalogManagementFetchProductListWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizCatalogManagementFetchProductListQuery")
public final class BizCatalogManagementFetchProductListWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     *                                      to omit the field
     */
    public BizCatalogManagementFetchProductListWhatsAppWebGraphQlRequest(Jid jid, List<String> productIds, String width, String height, String directConnectionEncryptedInfo) {
        this.jid = jid;
