 ...
 * {@link BizAdCreationLwiMediaUploadWhatsAppWebGraphQlRequest} into a list of {@link AdMediaUpload}.
 *
 ...
 * identifier.
 *
 * @see BizAdCreationLwiMediaUploadWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizAdCreationLWIMediaUploadMutation")
public final class BizAdCreationLwiMediaUploadWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private BizAdCreationLwiMediaUploadWhatsAppWebGraphQlResponse(List<AdMediaUpload> uploads) {
     ...
     */
    public static Optional<BizAdCreationLwiMediaUploadWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        return Optional.of(new BizAdCreationLwiMediaUploadWhatsAppWebGraphQlResponse(parseUploads(node.getJSONArray("uploaded_media_data"))));
    }
