 ...
 * through {@link BizGraphQlRefreshCartJobWhatsAppWebGraphQlResponse}.
 *
 ...
 *
 * @see BizGraphQlRefreshCartJobWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizGraphQLRefreshCartJobQuery")
public final class BizGraphQlRefreshCartJobWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     *                                      omit the field
     */
    public BizGraphQlRefreshCartJobWhatsAppWebGraphQlRequest(Jid jid, List<String> productIds, Integer imageWidth, Integer imageHeight, String directConnectionEncryptedInfo, String variantInfoFields) {
        this.jid = jid;
