 ...
 */
final class HttpSocketClientTunnelLayer implements SocketClientTunnelLayer {
     ...
     */
    HttpSocketClientTunnelLayer(WhatsAppClientProxy.Http proxy, SocketClientLayer<?> innerLayer) {
        this.proxy = proxy;
