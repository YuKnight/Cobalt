 ...
 * {@link GetAccountNonceWhatsAppWebGraphQlResponse}.
 *
 * @see GetAccountNonceWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebGetAccountNonceMutation")
public final class GetAccountNonceWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public GetAccountNonceWhatsAppWebGraphQlRequest(String scope) {
        this.scope = scope;
    }
