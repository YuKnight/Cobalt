...
public final class WhatsAppClientDevice {
    /**
     ...
     */
    private static final List<WhatsAppClientDevice> IOS_DEVICES = List.of(
            new WhatsAppClientDevice(
                    "iPhone 7",
                    "Apple",
                    null,
     ...
     */
    public static WhatsAppClientDevice web() {
        return new WhatsAppClientDevice(
                "Chrome",
                "Google Inc.",
     ...
     */
    public static WhatsAppClientDevice desktop() {
        if (IS_MAC) {
            return new WhatsAppClientDevice(
                    "MacBook Pro",
                    "Apple",
     ...
     */
    public static WhatsAppClientDevice ios(boolean business) {
     ...
     */
    public static WhatsAppClientDevice android(boolean business) {
     ...
     */
    public WhatsAppClientDevice toPersonal() {
     ...
     */
    public WhatsAppClientDevice toBusiness() {
        return switch (platform) {
     ...
     */
    public WhatsAppClientDevice withPlatform(ClientPlatformType platform) {
        return new WhatsAppClientDevice(
                model,
                manufacturer,
    ...
    public boolean equals(Object o) {
        return o instanceof WhatsAppClientDevice that
