 ...
 * node (not a WhatsApp address). The relay returns the outcome under
 * {@code meta_ai_biz_agent_wa_mark_all_lead_gen_data_as_seen_for_flow}; the reply is consumed through
 * {@link BizAiLeadGenMarkAllSeenWhatsAppWebGraphQlResponse}.
 *
 * @see BizAiLeadGenMarkAllSeenWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizAiLeadGenMarkAllSeenMutation")
public final class BizAiLeadGenMarkAllSeenWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public BizAiLeadGenMarkAllSeenWhatsAppWebGraphQlRequest(String leadGenFlowId) {
