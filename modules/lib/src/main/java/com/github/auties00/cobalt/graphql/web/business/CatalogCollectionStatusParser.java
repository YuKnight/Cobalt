...
/**
 * Projects the status-only collection node returned by the catalog-management create-collection and
...
final class CatalogCollectionStatusParser {
    ...
    /**
     * Projects a status-only collection node onto a {@link BusinessProductCollection}.
     *
     ...
     *
     * @param collection the collection node, never {@code null}
