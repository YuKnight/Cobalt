 ...
 * {@link FetchAdEntryPointsConfigurationWhatsAppWebGraphQlRequest} into a list of {@link AdEntryPointEntitlement}.
 *
 ...
 *
 * @see FetchAdEntryPointsConfigurationWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebFetchAdEntryPointsConfigurationQuery")
public final class FetchAdEntryPointsConfigurationWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private FetchAdEntryPointsConfigurationWhatsAppWebGraphQlResponse(List<AdEntryPointEntitlement> entitlements) {
     ...
     */
    public static Optional<FetchAdEntryPointsConfigurationWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
            return Optional.empty();
        }

        var entitlements = parseEntitlements(data.getJSONArray("ctwa_client_entry_point_entitlement"));
        return Optional.of(new FetchAdEntryPointsConfigurationWhatsAppWebGraphQlResponse(entitlements));
    }
