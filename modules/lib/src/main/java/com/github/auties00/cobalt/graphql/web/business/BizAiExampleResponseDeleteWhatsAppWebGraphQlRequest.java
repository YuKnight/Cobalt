 ...
 * through {@link BizAiExampleResponseDeleteWhatsAppWebGraphQlResponse}.
 *
 ...
 *
 * @see BizAiExampleResponseDeleteWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizAiExampleResponseDeleteMutation")
public final class BizAiExampleResponseDeleteWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public BizAiExampleResponseDeleteWhatsAppWebGraphQlRequest(List<String> knowledgeTypesToDelete, List<String> faqIds) {
