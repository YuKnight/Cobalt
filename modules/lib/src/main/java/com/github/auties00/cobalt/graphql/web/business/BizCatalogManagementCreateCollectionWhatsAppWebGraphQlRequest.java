 ...
 * {@link BizCatalogManagementCreateCollectionWhatsAppWebGraphQlResponse}.
 *
 * @see BizCatalogManagementCreateCollectionWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizCatalogManagementCreateCollectionMutation")
public final class BizCatalogManagementCreateCollectionWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     *                         field
     */
    public BizCatalogManagementCreateCollectionWhatsAppWebGraphQlRequest(String name, List<String> productIds, Jid bizJid, String catalogSessionId) {
        this.name = name;
