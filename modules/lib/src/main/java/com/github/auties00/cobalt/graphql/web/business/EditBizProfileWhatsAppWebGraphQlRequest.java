 ...
 * {@link EditBizProfileWhatsAppWebGraphQlResponse}.
 *
 ...
 *
 * @see EditBizProfileWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebEditBizProfileMutation")
public final class EditBizProfileWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     *                  variable
     */
    public EditBizProfileWhatsAppWebGraphQlRequest(Jid lid, String inputJson) {
        this.lid = lid;
