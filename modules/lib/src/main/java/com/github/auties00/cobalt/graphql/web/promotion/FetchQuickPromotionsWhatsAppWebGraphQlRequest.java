 ...
 * {@link FetchQuickPromotionsWhatsAppWebGraphQlResponse}.
 *
 * @see FetchQuickPromotionsWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebFetchQuickPromotionsQuery")
public final class FetchQuickPromotionsWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public FetchQuickPromotionsWhatsAppWebGraphQlRequest(List<String> nuxIds, TriggerContext triggerContext) {
        this.nuxIds = nuxIds;
    ...
    public record TriggerContext(Boolean isFromWaSmb, String appVersion, String country, String locale) {
         ...
         *
         * <p>Reserved for {@link FetchQuickPromotionsWhatsAppWebGraphQlRequest#variables()}; writes each field only
