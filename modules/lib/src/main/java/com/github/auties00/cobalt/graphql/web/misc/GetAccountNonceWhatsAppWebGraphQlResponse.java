 ...
 * {@link GetAccountNonceWhatsAppWebGraphQlRequest} into a {@link BusinessAccountNonce}.
 *
 ...
 *
 * @see GetAccountNonceWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebGetAccountNonceMutation")
public final class GetAccountNonceWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private GetAccountNonceWhatsAppWebGraphQlResponse(BusinessAccountNonce nonce) {
        this.nonce = nonce;
    }
     ...
     *         missing
     */
    public static Optional<GetAccountNonceWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        var nonce = new BusinessAccountNonceBuilder()
                ...
                .requestId(requestId)
                .build();
        return Optional.of(new GetAccountNonceWhatsAppWebGraphQlResponse(nonce));
    }
