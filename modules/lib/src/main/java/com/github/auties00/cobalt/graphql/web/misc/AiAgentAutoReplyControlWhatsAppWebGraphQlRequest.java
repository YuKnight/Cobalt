 ...
 * {@link AiAgentAutoReplyControlWhatsAppWebGraphQlResponse}.
 *
 * @see AiAgentAutoReplyControlWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebAiAgentAutoReplyControlMutation")
public final class AiAgentAutoReplyControlWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public AiAgentAutoReplyControlWhatsAppWebGraphQlRequest(Jid consumerLid, String phoneNumber, ThreadStatus threadStatus) {
