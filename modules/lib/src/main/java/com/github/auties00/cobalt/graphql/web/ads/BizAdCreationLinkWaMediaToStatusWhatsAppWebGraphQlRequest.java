 ...
 * {@link BizAdCreationLinkWaMediaToStatusWhatsAppWebGraphQlResponse}.
 *
 * @see BizAdCreationLinkWaMediaToStatusWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizAdCreationLinkWAMediaToStatusMutation")
public final class BizAdCreationLinkWaMediaToStatusWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public BizAdCreationLinkWaMediaToStatusWhatsAppWebGraphQlRequest(List<MediaEntry> mediaList) {
