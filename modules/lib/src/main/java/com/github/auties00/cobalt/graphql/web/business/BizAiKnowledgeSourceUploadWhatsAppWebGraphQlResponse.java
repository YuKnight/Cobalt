 ...
 * {@link BizAiKnowledgeSourceUploadWhatsAppWebGraphQlRequest} into a {@link BusinessAiMutationResult}.
 *
 ...
 *
 * @see BizAiKnowledgeSourceUploadWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizAiKnowledgeSourceUploadMutation")
public final class BizAiKnowledgeSourceUploadWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private BizAiKnowledgeSourceUploadWhatsAppWebGraphQlResponse(BusinessAiMutationResult result) {
        this.result = result;
    }
     ...
     */
    public static Optional<BizAiKnowledgeSourceUploadWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        if (node == null) {
            return Optional.of(new BizAiKnowledgeSourceUploadWhatsAppWebGraphQlResponse(null));
        }
        ...
        var result = new BusinessAiMutationResultBuilder()
                ...
                .build();
        return Optional.of(new BizAiKnowledgeSourceUploadWhatsAppWebGraphQlResponse(result));
    }
