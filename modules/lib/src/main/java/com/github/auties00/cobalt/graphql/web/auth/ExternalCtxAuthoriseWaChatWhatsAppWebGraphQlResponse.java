 ...
 * {@link ExternalCtxAuthoriseWaChatWhatsAppWebGraphQlRequest} into an
 ...
 *
 * @see ExternalCtxAuthoriseWaChatWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebExternalCtxAuthoriseWAChatMutation")
public final class ExternalCtxAuthoriseWaChatWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private ExternalCtxAuthoriseWaChatWhatsAppWebGraphQlResponse(ExternalChatDeepLinkAuthorization authorization) {
     ...
     */
    public static Optional<ExternalCtxAuthoriseWaChatWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        var authorization = new ExternalChatDeepLinkAuthorizationBuilder()
                ...
                .build();
        return Optional.of(new ExternalCtxAuthoriseWaChatWhatsAppWebGraphQlResponse(authorization));
    }
