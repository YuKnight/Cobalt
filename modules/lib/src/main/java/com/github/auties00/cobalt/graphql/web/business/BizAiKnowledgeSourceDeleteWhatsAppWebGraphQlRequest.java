 ...
 * {@link BizAiKnowledgeSourceDeleteWhatsAppWebGraphQlResponse}.
 *
 * @see BizAiKnowledgeSourceDeleteWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizAiKnowledgeSourceDeleteMutation")
public final class BizAiKnowledgeSourceDeleteWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     *                                 omit the field
     */
    public BizAiKnowledgeSourceDeleteWhatsAppWebGraphQlRequest(String uploadedFileDataSourceId) {
