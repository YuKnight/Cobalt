 ...
 * {@link BizAiReplyBotEnabledTimeUpdateWhatsAppWebGraphQlRequest} into a {@link BusinessAiMutationResult}.
 *
 ...
 *
 * @see BizAiReplyBotEnabledTimeUpdateWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizAiReplyBotEnabledTimeUpdateMutation")
public final class BizAiReplyBotEnabledTimeUpdateWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private BizAiReplyBotEnabledTimeUpdateWhatsAppWebGraphQlResponse(BusinessAiMutationResult result) {
        this.result = result;
    }
     ...
     */
    public static Optional<BizAiReplyBotEnabledTimeUpdateWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        if (node == null) {
            return Optional.of(new BizAiReplyBotEnabledTimeUpdateWhatsAppWebGraphQlResponse(null));
        }

        var result = new BusinessAiMutationResultBuilder()
                .success(Boolean.TRUE.equals(node.getBoolean("success")))
                .build();
        return Optional.of(new BizAiReplyBotEnabledTimeUpdateWhatsAppWebGraphQlResponse(result));
    }
