 ...
 * {@link FetchMetaAiSearchNullStateSuggestionsWhatsAppWebGraphQlResponse}.
 *
 * @see FetchMetaAiSearchNullStateSuggestionsWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebFetchMetaAISearchNullStateSuggestionsQuery")
public final class FetchMetaAiSearchNullStateSuggestionsWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public FetchMetaAiSearchNullStateSuggestionsWhatsAppWebGraphQlRequest(String locale, String nullStateSource, List<Integer> expConfig) {
        this.locale = locale;
