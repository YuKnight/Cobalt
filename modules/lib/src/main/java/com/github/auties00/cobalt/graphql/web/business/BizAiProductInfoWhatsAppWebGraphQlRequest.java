 ...
 * {@link BizAiProductInfoWhatsAppWebGraphQlResponse}.
 *
 ...
 *
 * @see BizAiProductInfoWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizAiProductInfoMutation")
public final class BizAiProductInfoWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     *
     * <p>Equivalent to {@link #BizAiProductInfoWhatsAppWebGraphQlRequest(String, String, String, List, String,
     ...
     *                               omit the field
     */
    public BizAiProductInfoWhatsAppWebGraphQlRequest(String name, String complexPriceJson, String description, List<String> manifoldImageFilePaths, String existingImagesJson) {
     ...
     *                               field
     */
    public BizAiProductInfoWhatsAppWebGraphQlRequest(String name, String complexPriceJson, String description, List<String> manifoldImageFilePaths, String existingImagesJson, String thumbnailHeight, String thumbnailWidth) {
        this.name = name;
