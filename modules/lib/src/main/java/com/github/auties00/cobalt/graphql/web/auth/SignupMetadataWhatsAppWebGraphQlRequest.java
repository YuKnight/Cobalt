 ...
 * is consumed through {@link SignupMetadataWhatsAppWebGraphQlResponse}.
 *
 * @see SignupMetadataWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebSignupMetadataQuery")
public final class SignupMetadataWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     *                    variable
     */
    public SignupMetadataWhatsAppWebGraphQlRequest(String signupId, String phoneNumber) {
