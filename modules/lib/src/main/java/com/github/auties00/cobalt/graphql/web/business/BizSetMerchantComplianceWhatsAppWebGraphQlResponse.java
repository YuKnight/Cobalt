 ...
 * {@link BizSetMerchantComplianceWhatsAppWebGraphQlRequest} into a {@link BusinessMerchantCompliance}.
 *
 ...
 *
 * @see BizSetMerchantComplianceWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizSetMerchantComplianceMutation")
public final class BizSetMerchantComplianceWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     *                     field
     */
    private BizSetMerchantComplianceWhatsAppWebGraphQlResponse(BusinessMerchantCompliance merchantInfo) {
    ...
    public static Optional<BizSetMerchantComplianceWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        var merchant = new BusinessMerchantComplianceBuilder()
                ...
                .grievanceOfficerDetails(new BusinessGrievanceOfficerDetailsBuilder()
                        ...
                        .build())
                .build();
        return Optional.of(new BizSetMerchantComplianceWhatsAppWebGraphQlResponse(merchant));
    }
