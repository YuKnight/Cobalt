 ...
 * {@link AuthAgentFeaturePolicyWhatsAppWebGraphQlRequest} into an {@link AuthorizedAgentFeaturePolicy}.
 *
 ...
 *
 * @see AuthAgentFeaturePolicyWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebAuthAgentFeaturePolicyQuery")
public final class AuthAgentFeaturePolicyWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private AuthAgentFeaturePolicyWhatsAppWebGraphQlResponse(AuthorizedAgentFeaturePolicy policy) {
        this.policy = policy;
    }
     ...
     */
    public static Optional<AuthAgentFeaturePolicyWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        var policy = new AuthorizedAgentFeaturePolicyBuilder()
                ...
                .build();
        return Optional.of(new AuthAgentFeaturePolicyWhatsAppWebGraphQlResponse(policy));
    }
