 ...
 * response to an {@link IqSendCoverPhotoRequest}.
 */
...
public sealed interface IqSendCoverPhotoResponse extends IqOperation.Response
    ...
    /**
     * Tries each {@link IqSendCoverPhotoResponse} variant in priority order.
     *
    ...
    /**
     * The {@code Success} reply variant — empty payload.
     */
