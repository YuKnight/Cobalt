 ...
 * {@link GraphQlProductCatalogGetPublicKeyJobWhatsAppWebGraphQlRequest} into a {@link BusinessCatalogPublicKey}.
 *
 ...
 *
 * @see GraphQlProductCatalogGetPublicKeyJobWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebGraphQLProductCatalogGetPublicKeyJobQuery")
public final class GraphQlProductCatalogGetPublicKeyJobWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private GraphQlProductCatalogGetPublicKeyJobWhatsAppWebGraphQlResponse(BusinessCatalogPublicKey publicKey) {
    ...
    public static Optional<GraphQlProductCatalogGetPublicKeyJobWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        var publicKey = new BusinessCatalogPublicKeyBuilder()
                ...
                .build();
        return Optional.of(new GraphQlProductCatalogGetPublicKeyJobWhatsAppWebGraphQlResponse(publicKey));
    }
