 ...
 * {@link QueryCatalogHasCategoriesWhatsAppWebGraphQlRequest}.
 *
 ...
 *
 * @see QueryCatalogHasCategoriesWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebQueryCatalogHasCategoriesQuery")
public final class QueryCatalogHasCategoriesWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private QueryCatalogHasCategoriesWhatsAppWebGraphQlResponse(Categories categories) {
     ...
     */
    public static Optional<QueryCatalogHasCategoriesWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
            return Optional.empty();
        }

        var categories = Categories.of(data.getJSONObject("xwa_product_catalog_get_categories")).orElse(null);
        return Optional.of(new QueryCatalogHasCategoriesWhatsAppWebGraphQlResponse(categories));
    }
    ...
    public static final class Categories {
         ...
         *
         * <p>Used by {@link QueryCatalogHasCategoriesWhatsAppWebGraphQlResponse#of(JSONObject)} to hydrate the
    ...
    public static final class Category {
        ...
        static Optional<Category> of(JSONObject obj) {
            ...
            return Optional.of(new Category(WhatsAppWebGraphQlOperation.Response.getTypename(obj).orElse(null)));
        }
