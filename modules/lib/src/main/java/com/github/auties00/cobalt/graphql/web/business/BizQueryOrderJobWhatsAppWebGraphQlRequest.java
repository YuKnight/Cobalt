 ...
 * reply is consumed through {@link BizQueryOrderJobWhatsAppWebGraphQlResponse}.
 *
 * @see BizQueryOrderJobWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizQueryOrderJobQuery")
public final class BizQueryOrderJobWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     *                                      {@code null} to omit it
     */
    public BizQueryOrderJobWhatsAppWebGraphQlRequest(Jid jid, String orderId, String token, Integer height, Integer width, String directConnectionEncryptedInfo) {
        this.jid = jid;
