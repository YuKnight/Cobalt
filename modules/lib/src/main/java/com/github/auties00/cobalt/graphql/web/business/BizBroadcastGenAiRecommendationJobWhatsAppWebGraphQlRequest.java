 ...
 * consumed through {@link BizBroadcastGenAiRecommendationJobWhatsAppWebGraphQlResponse}.
 *
 * @see BizBroadcastGenAiRecommendationJobWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizBroadcastGenAIRecommendationJobQuery")
public final class BizBroadcastGenAiRecommendationJobWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public BizBroadcastGenAiRecommendationJobWhatsAppWebGraphQlRequest(String actorId, String model, String userInfo, String userMessageDraft, String userPrompt) {
