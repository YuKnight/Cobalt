 ...
 * {@link QueryCatalogHasCategoriesWhatsAppWebGraphQlResponse}.
 *
 * @see QueryCatalogHasCategoriesWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebQueryCatalogHasCategoriesQuery")
public final class QueryCatalogHasCategoriesWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     *                                      used
     */
    public QueryCatalogHasCategoriesWhatsAppWebGraphQlRequest(Jid bizJid, String directConnectionEncryptedInfo,
