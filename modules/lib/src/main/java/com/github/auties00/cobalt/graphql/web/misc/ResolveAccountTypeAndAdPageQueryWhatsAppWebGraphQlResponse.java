 ...
 * {@link ResolveAccountTypeAndAdPageQueryWhatsAppWebGraphQlRequest} into a {@link WhatsAppAdsPageEligibility}.
 *
 ...
 * create-ads verdict.
 *
 * @see ResolveAccountTypeAndAdPageQueryWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebResolveAccountTypeAndAdPageQuery")
public final class ResolveAccountTypeAndAdPageQueryWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     *                    field
     */
    private ResolveAccountTypeAndAdPageQueryWhatsAppWebGraphQlResponse(WhatsAppAdsPageEligibility eligibility) {
     ...
     */
    public static Optional<ResolveAccountTypeAndAdPageQueryWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        var eligibility = new WhatsAppAdsPageEligibilityBuilder()
                ...
                .build();
        return Optional.of(new ResolveAccountTypeAndAdPageQueryWhatsAppWebGraphQlResponse(eligibility));
    }
