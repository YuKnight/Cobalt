 ...
 * {@link FetchOidcStateWhatsAppWebGraphQlRequest}.
 *
 ...
 *
 * @see FetchOidcStateWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebFetchOIDCStateQuery")
public final class FetchOidcStateWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private FetchOidcStateWhatsAppWebGraphQlResponse(String oidcState) {
     ...
     */
    public static Optional<FetchOidcStateWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
            return Optional.empty();
        }

        var oidcState = data.getString("xfb_wa_biz_get_oidc_state");
        return Optional.of(new FetchOidcStateWhatsAppWebGraphQlResponse(oidcState));
    }
