 ...
 *
 * <p>Carries the raw {@code <verified_name>} child node so callers can decode
 * it through their own verified-name protobuf decoder. Mirroring the way
...
public final class BusinessResult implements UsyncProtocolResponse {
    /**
     * Holds the {@code <verified_name>} child node, or {@code null} when the
