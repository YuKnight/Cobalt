 ...
 * {@link GalaxyFlowsDrawerGetFlowDataWhatsAppWebGraphQlResponse}.
 *
 * @see GalaxyFlowsDrawerGetFlowDataWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebGalaxyFlowsDrawerGetFlowDataQuery")
public final class GalaxyFlowsDrawerGetFlowDataWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public GalaxyFlowsDrawerGetFlowDataWhatsAppWebGraphQlRequest(Jid bizJid, String flowId) {
        this.bizJid = bizJid;
        this.flowId = flowId;
    }
