 ...
 * reply is consumed through {@link BizAiExampleResponsesWhatsAppWebGraphQlResponse}.
 *
 * @see BizAiExampleResponsesWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizAiExampleResponsesQuery")
public final class BizAiExampleResponsesWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public BizAiExampleResponsesWhatsAppWebGraphQlRequest() {
    }
