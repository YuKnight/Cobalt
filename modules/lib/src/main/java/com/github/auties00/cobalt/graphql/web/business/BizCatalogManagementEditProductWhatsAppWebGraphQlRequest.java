 ...
 * the reply is consumed through {@link BizCatalogManagementEditProductWhatsAppWebGraphQlResponse}.
 *
 ...
 *
 * @see BizCatalogManagementEditProductWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizCatalogManagementEditProductMutation")
public final class BizCatalogManagementEditProductWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public BizCatalogManagementEditProductWhatsAppWebGraphQlRequest(Jid bizJid, String productId, Integer width, Integer height, String productInfoJson) {
        this.bizJid = bizJid;
