 ...
 * {@link ReportProductJobWhatsAppWebGraphQlResponse}.
 *
 * @see ReportProductJobWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebReportProductJobMutation")
public final class ReportProductJobWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public ReportProductJobWhatsAppWebGraphQlRequest(Jid catalogJid, String productId, String reason) {
