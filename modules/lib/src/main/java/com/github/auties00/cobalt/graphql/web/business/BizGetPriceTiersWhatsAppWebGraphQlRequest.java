 ...
 * {@link BizGetPriceTiersWhatsAppWebGraphQlResponse}.
 *
 * @see BizGetPriceTiersWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizGetPriceTiersQuery")
public final class BizGetPriceTiersWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public BizGetPriceTiersWhatsAppWebGraphQlRequest(String locale) {
        this.locale = locale;
    }
