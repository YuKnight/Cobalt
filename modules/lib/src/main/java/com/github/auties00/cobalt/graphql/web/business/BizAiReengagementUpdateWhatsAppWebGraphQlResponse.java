 ...
 * {@link BizAiReengagementUpdateWhatsAppWebGraphQlRequest} into a {@link BusinessAiMutationResult}.
 *
 ...
 * flag, so the presence of the echoed node is read as success.
 *
 * @see BizAiReengagementUpdateWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizAiReengagementUpdateMutation")
public final class BizAiReengagementUpdateWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private BizAiReengagementUpdateWhatsAppWebGraphQlResponse(BusinessAiMutationResult result) {
        this.result = result;
    }
     ...
     */
    public static Optional<BizAiReengagementUpdateWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        if (node == null) {
            return Optional.of(new BizAiReengagementUpdateWhatsAppWebGraphQlResponse(null));
        }

        var result = new BusinessAiMutationResultBuilder()
                .success(true)
                .build();
        return Optional.of(new BizAiReengagementUpdateWhatsAppWebGraphQlResponse(result));
    }
