 ...
 * {@code xwa_get_subscriptions}; the reply is consumed through {@link FetchSubscriptionsWhatsAppWebGraphQlResponse}.
 *
 * @see FetchSubscriptionsWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebFetchSubscriptionsQuery")
public final class FetchSubscriptionsWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public FetchSubscriptionsWhatsAppWebGraphQlRequest(String platform) {
