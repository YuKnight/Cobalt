...
public interface ConnectionStore {
     ...
     */
    ConnectionStore setProxy(WhatsAppClientProxy proxy);
     ...
     * @return this store instance for method chaining
     */
    ConnectionStore setOfflineResumeState(LinkedWhatsAppClientOfflineResumeState state);
     ...
     * @return this store instance for method chaining
     */
    ConnectionStore setRoutingInfo(byte[] routingInfo);
     ...
     * @return this store instance for method chaining
     */
    ConnectionStore setRoutingDomain(String routingDomain);
}
