 ...
 * {@link BizAiProductInfoMutationDeleteWhatsAppWebGraphQlResponse}.
 *
 * @see BizAiProductInfoMutationDeleteWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizAiProductInfoMutationDeleteMutation")
public final class BizAiProductInfoMutationDeleteWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public BizAiProductInfoMutationDeleteWhatsAppWebGraphQlRequest(List<String> productIds) {
