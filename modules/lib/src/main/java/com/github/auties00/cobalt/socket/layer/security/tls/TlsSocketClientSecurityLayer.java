...
public final class TlsSocketClientSecurityLayer implements SocketClientTunnelSecurityLayer, SocketClientTransportSecurityLayer {
     ...
     * given peer address.
     */
    private final Function<InetSocketAddress, SSLEngine> engineFactory;
     ...
     */
    public TlsSocketClientSecurityLayer(SocketClientLayer innerLayer, Function<InetSocketAddress, SSLEngine> engineFactory) {
    ...
    public void startHandshake() throws IOException {
        var engine = engineFactory.apply(peerAddress);
