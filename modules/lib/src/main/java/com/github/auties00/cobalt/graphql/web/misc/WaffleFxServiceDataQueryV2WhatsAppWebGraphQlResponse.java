 ...
 * built by {@link WaffleFxServiceDataQueryV2WhatsAppWebGraphQlRequest} into a
 ...
 *
 * @see WaffleFxServiceDataQueryV2WhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebWaffleFXServiceDataQueryV2Mutation")
public final class WaffleFxServiceDataQueryV2WhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     *                    field
     */
    private WaffleFxServiceDataQueryV2WhatsAppWebGraphQlResponse(CrossPostingServiceData serviceData) {
     ...
     *         missing
     */
    public static Optional<WaffleFxServiceDataQueryV2WhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        var serviceData = new CrossPostingServiceDataBuilder()
                ...
                .build();
        return Optional.of(new WaffleFxServiceDataQueryV2WhatsAppWebGraphQlResponse(serviceData));
    }
