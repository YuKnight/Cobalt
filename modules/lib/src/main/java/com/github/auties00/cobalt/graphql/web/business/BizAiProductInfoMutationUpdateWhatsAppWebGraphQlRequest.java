 ...
 * {@link BizAiProductInfoMutationUpdateWhatsAppWebGraphQlResponse}.
 *
 ...
 *
 * @see BizAiProductInfoMutationUpdateWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizAiProductInfoMutationUpdateMutation")
public final class BizAiProductInfoMutationUpdateWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     *                               the field
     */
    public BizAiProductInfoMutationUpdateWhatsAppWebGraphQlRequest(String id, String name, String complexPrice, String description, List<String> manifoldImageFilePaths, List<String> images) {
        this.id = id;
        this.name = name;
