 ...
 * {@link BizAiProductInfoMutationDeleteWhatsAppWebGraphQlRequest} into a list of {@link BusinessAiMutationResult}.
 *
 ...
 *
 * @see BizAiProductInfoMutationDeleteWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizAiProductInfoMutationDeleteMutation")
public final class BizAiProductInfoMutationDeleteWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private BizAiProductInfoMutationDeleteWhatsAppWebGraphQlResponse(List<BusinessAiMutationResult> results) {
     ...
     */
    public static Optional<BizAiProductInfoMutationDeleteWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
            return Optional.empty();
        }

        var results = parseResults(data.getJSONArray("xfb_maiba_multi_delete_product_info_knowledge"));
        return Optional.of(new BizAiProductInfoMutationDeleteWhatsAppWebGraphQlResponse(results));
    }
