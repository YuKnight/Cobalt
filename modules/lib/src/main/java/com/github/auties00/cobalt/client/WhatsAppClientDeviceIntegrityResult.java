 ...
 * {@link WhatsAppClientDeviceIntegrityProvider}.
 *
 ...
 * {@link WhatsAppClientDeviceIntegrityProvider} the embedding application
 * supplies, typically by delegating the minting to a real device it
 * controls.
 *
 * @see WhatsAppClientDeviceIntegrityProvider
 */
public sealed interface WhatsAppClientDeviceIntegrityResult
        permits WhatsAppClientDeviceIntegrityResult.PlayIntegrity,
                WhatsAppClientDeviceIntegrityResult.AppAttest {
    ...
    record PlayIntegrity(String gpia, String gg, String gi, String gp)
            implements WhatsAppClientDeviceIntegrityResult {
        /**
