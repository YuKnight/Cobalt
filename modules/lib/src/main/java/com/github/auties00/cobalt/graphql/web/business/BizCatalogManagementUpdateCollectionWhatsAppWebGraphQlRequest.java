 ...
 * {@link BizCatalogManagementUpdateCollectionWhatsAppWebGraphQlResponse}.
 *
 * @see BizCatalogManagementUpdateCollectionWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizCatalogManagementUpdateCollectionMutation")
public final class BizCatalogManagementUpdateCollectionWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     *                         {@code remove} member
     */
    public BizCatalogManagementUpdateCollectionWhatsAppWebGraphQlRequest(String id, Jid bizJid, String catalogSessionId, String name, List<String> addIds, List<String> removeIds) {
        this.id = id;
        this.bizJid = bizJid;
