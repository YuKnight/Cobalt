 ...
 * the reply is consumed through {@link CreateWhatsAppAdsIdentityWhatsAppWebGraphQlResponse}.
 *
 * @see CreateWhatsAppAdsIdentityWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebCreateWhatsAppAdsIdentityMutation")
public final class CreateWhatsAppAdsIdentityWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public CreateWhatsAppAdsIdentityWhatsAppWebGraphQlRequest(String phoneNumber, String code) {
