 ...
 * {@link BizAiKnowledgeSourceDeleteMutationChatHistoryWhatsAppWebGraphQlResponse}.
 *
 * @see BizAiKnowledgeSourceDeleteMutationChatHistoryWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizAiKnowledgeSourceDeleteMutationChatHistoryMutation")
public final class BizAiKnowledgeSourceDeleteMutationChatHistoryWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public BizAiKnowledgeSourceDeleteMutationChatHistoryWhatsAppWebGraphQlRequest() {
    }
