 ...
 * {@link BizCatalogManagementUpdateCollectionWhatsAppWebGraphQlRequest} into a {@link BusinessProductCollection}.
 *
 ...
 * empty.
 *
 * @see BizCatalogManagementUpdateCollectionWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizCatalogManagementUpdateCollectionMutation")
public final class BizCatalogManagementUpdateCollectionWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private BizCatalogManagementUpdateCollectionWhatsAppWebGraphQlResponse(BusinessProductCollection collection) {
    ...
    public static Optional<BizCatalogManagementUpdateCollectionWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        return Optional.of(new BizCatalogManagementUpdateCollectionWhatsAppWebGraphQlResponse(collection));
    }
