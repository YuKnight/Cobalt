 ...
 * {@link BizAiExampleResponsesWhatsAppWebGraphQlRequest} into a {@link BusinessAiAgentHome}.
 *
 ...
 * not request them.
 *
 * @see BizAiExampleResponsesWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizAiExampleResponsesQuery")
public final class BizAiExampleResponsesWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private BizAiExampleResponsesWhatsAppWebGraphQlResponse(BusinessAiAgentHome agentHome) {
     ...
     */
    public static Optional<BizAiExampleResponsesWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        if (home == null) {
            return Optional.of(new BizAiExampleResponsesWhatsAppWebGraphQlResponse(null));
        }
        ...
        var agentHome = new BusinessAiAgentHomeBuilder()
                ...
                .build();
        return Optional.of(new BizAiExampleResponsesWhatsAppWebGraphQlResponse(agentHome));
    }
    ...
    /**
     * Projects a {@code faq_data} node onto a {@link BusinessAiExampleResponse}.
     *
     * @param obj the {@code faq_data} node, possibly {@code null}
    ...
    /**
     * Projects the {@code knowledge} node onto a {@link BusinessAiWebsiteKnowledge}.
     *
     * @param obj the {@code knowledge} node, possibly {@code null}
    ...
    /**
     * Reads the {@code eligible} flag from the {@code product_info_eligibility} node.
     *
     * @param obj the {@code product_info_eligibility} node, possibly {@code null}
     * @return {@code true} when the node reports eligibility, {@code false} otherwise
     */
