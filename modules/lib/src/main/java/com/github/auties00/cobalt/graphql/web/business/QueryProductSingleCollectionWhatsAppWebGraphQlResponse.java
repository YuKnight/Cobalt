 ...
 * {@link QueryProductSingleCollectionWhatsAppWebGraphQlRequest} into a {@link BusinessProductCollection}.
 *
 ...
 *
 * @see QueryProductSingleCollectionWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebQueryProductSingleCollectionQuery")
public final class QueryProductSingleCollectionWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private QueryProductSingleCollectionWhatsAppWebGraphQlResponse(BusinessProductCollection collection) {
    ...
    public static Optional<QueryProductSingleCollectionWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        var collection = new BusinessProductCollectionBuilder()
                ...
                .afterCursor(after)
                .build();
        return Optional.of(new QueryProductSingleCollectionWhatsAppWebGraphQlResponse(collection));
    }
