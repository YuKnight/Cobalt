 ...
 * {@link BizAiKnowledgeSourceDeleteMutationWebsiteWhatsAppWebGraphQlResponse}.
 *
 * @see BizAiKnowledgeSourceDeleteMutationWebsiteWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizAiKnowledgeSourceDeleteMutationWebsiteMutation")
public final class BizAiKnowledgeSourceDeleteMutationWebsiteWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     *                            field
     */
    public BizAiKnowledgeSourceDeleteMutationWebsiteWhatsAppWebGraphQlRequest(String websiteDataSourceId) {
