 ...
 * {@link BizAiRulesGenWhatsAppWebGraphQlRequest} into a list of {@link BusinessAiRule}.
 *
 ...
 *
 * @see BizAiRulesGenWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizAiRulesGenMutation")
public final class BizAiRulesGenWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private BizAiRulesGenWhatsAppWebGraphQlResponse(List<BusinessAiRule> rules) {
        this.rules = rules;
    }
     ...
     */
    public static Optional<BizAiRulesGenWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        if (node == null || !Boolean.TRUE.equals(node.getBoolean("success"))) {
            return Optional.of(new BizAiRulesGenWhatsAppWebGraphQlResponse(List.of()));
        }

        var rules = BizAiRuleProjection.ofArray(node.getJSONArray("rules"));
        return Optional.of(new BizAiRulesGenWhatsAppWebGraphQlResponse(rules));
    }
