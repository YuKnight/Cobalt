 ...
 * {@link FetchMetaAiSearchNullStateSuggestionsWhatsAppWebGraphQlRequest} into a {@link MetaAiSearchSuggestions}.
 *
 ...
 *
 * @see FetchMetaAiSearchNullStateSuggestionsWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebFetchMetaAISearchNullStateSuggestionsQuery")
public final class FetchMetaAiSearchNullStateSuggestionsWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     *                    field
     */
    private FetchMetaAiSearchNullStateSuggestionsWhatsAppWebGraphQlResponse(MetaAiSearchSuggestions suggestions) {
     ...
     */
    public static Optional<FetchMetaAiSearchNullStateSuggestionsWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        var suggestions = new MetaAiSearchSuggestionsBuilder()
                ...
                .build();
        return Optional.of(new FetchMetaAiSearchNullStateSuggestionsWhatsAppWebGraphQlResponse(suggestions));
    }
