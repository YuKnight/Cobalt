...
public sealed class LinkedWhatsAppClientBuilder {
    ...
    /**
     * The shared root builder, accessed via {@link LinkedWhatsAppClient#builder()}.
     */
    static final LinkedWhatsAppClientBuilder INSTANCE = new LinkedWhatsAppClientBuilder();

    /**
     * Private singleton constructor; obtain instances via
     * {@link LinkedWhatsAppClient#builder()}.
     */
    private LinkedWhatsAppClientBuilder() {
    ...
    public static sealed class Options extends LinkedWhatsAppClientBuilder {
         ...
         * @return this builder, for chaining
         */
        public Options device(WhatsAppClientDevice device) {
        ...
        public static final class Web extends Options {
             ...
             */
            @Override
            public Web device(WhatsAppClientDevice device) {
             ...
             *                              {@code null}
             */
            public LinkedWhatsAppClient unregistered(WhatsAppClientVerificationHandler.Web.QrCode qrHandler) {
             ...
             *                              is {@code null}
             */
            public LinkedWhatsAppClient unregistered(long phoneNumber, WhatsAppClientVerificationHandler.Web.PairingCode pairingCodeHandler) {
        ...
        public static final class Mobile extends Options {
             ...
             * at most one of {@link WhatsAppClientDeviceAttestor.Android} or
             * {@link WhatsAppClientDeviceAttestor.Ios}; {@code null} means "no
             * attestor configured" and the registration falls back to
             * the concrete subclass's {@code EMPTY_ATTESTOR} default.
             */
            private WhatsAppClientDeviceAttestor attestor;

            /**
             * Push client captured by
             * {@link #devicePushClient(WhatsAppClientDevicePushClient)}, the
             ...
             * {@link WhatsAppClientDevicePushClient#noop()}, which emits
             * empty {@code push_token} and {@code push_code} form
             * fields.
             */
            private WhatsAppClientDevicePushClient pushClient;
             ...
             * closed via {@link WhatsAppClientDevicePushClient#close()}
             ...
             */
            private Supplier<WhatsAppClientDevicePushClient> pushClientSupplier;

            /**
             * Tracks whether the caller has explicitly selected the
             * device via {@link #device(WhatsAppClientDevice)}, as opposed to
             ...
             * {@link WhatsAppClientDevicePushClient#supportedPlatforms()} set and the
             * call raises {@link IllegalArgumentException} on a
             ...
             */
            @Override
            public Mobile device(WhatsAppClientDevice device) {
                if (device != null) {
             ...
             *
             * <p>If {@link #device(WhatsAppClientDevice)} has already been
             ...
             *                                  {@code attestor}
             */
            public Mobile deviceAttestor(WhatsAppClientDeviceAttestor attestor) {
             ...
             * never invokes {@link WhatsAppClientDevicePushClient#close()}
             ...
             * {@link WhatsAppClientDevicePushClient#supportedPlatforms()}
             ...
             */
            public Mobile devicePushClient(WhatsAppClientDevicePushClient pushClient) {
             ...
             * {@link WhatsAppClientDevicePushClient} instance is owned by
             * the builder: it is closed via
             * {@link WhatsAppClientDevicePushClient#close()} after the
             ...
             * {@link #devicePushClient(WhatsAppClientDevicePushClient)}.
             *
             ...
             * no immediate {@link WhatsAppClientDevicePushClient#supportedPlatforms()}
             ...
             * low-trust lane ({@link WhatsAppClientDevicePushClient#noop()}).
             ...
             * @return the same instance for chaining
             */
            public Mobile devicePushClient(Supplier<WhatsAppClientDevicePushClient> pushClientSupplier) {
             ...
             * {@link #devicePushClient(WhatsAppClientDevicePushClient)} and
             ...
             */
            private static void requirePlatformMatches(WhatsAppClientDevice device, WhatsAppClientDeviceAttestor attestor) {
                if (attestor == null) {
                    return;
                }
                var platform = device.platform();
                switch (attestor) {
                    case WhatsAppClientDeviceAttestor.Android ignored -> {
                    ...
                    case WhatsAppClientDeviceAttestor.Ios ignored -> {
             ...
             * {@link WhatsAppClientDevicePushClient#noop()}, which accepts every
             * platform.
             *
             ...
             *                                  supported set
             */
            private static void requirePushClientSupportsDevice(WhatsAppClientDevice device, WhatsAppClientDevicePushClient pushClient) {
                if (pushClient == null) {
                    return;
                }
                var platform = device.platform();
             ...
             */
            public LinkedWhatsAppClient register(long phoneNumber, WhatsAppClientVerificationHandler.Mobile verification) {
