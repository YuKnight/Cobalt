...
public sealed interface SocketClientLayerContext
        permits WhatsAppLayerContext, WebSocketLayerContext, SocketClientTunnelLayerContext, TlsSocketClientLayerContext {
    /**
     ...
     * or {@code null} if this is the topmost context.
     *
     * @return the next layer context, or {@code null}
     */
    default SocketClientLayerContext nextLayer() {
        return null;
    }
     ...
     *
     * <p>Called by the auto-chaining logic in
     * {@link SocketClientContext#createLayerContext(Class, SocketClientLayerContext)}
     * when a new context is registered above this one.
     *
