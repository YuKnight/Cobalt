 ...
 * {@link BizGetCategoriesV2WhatsAppWebGraphQlRequest} into a tree of {@link BusinessCategoryNode}.
 *
 * <p>Reads the linked {@code whatsapp_catkit_typeahead_proxy} field and projects its nested
 * {@code categories} tree, where each node carries an id, a localised display name, and its own
 * children, onto the Cobalt domain model.
 *
 * @see BizGetCategoriesV2WhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizGetCategoriesV2Query")
public final class BizGetCategoriesV2WhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private BizGetCategoriesV2WhatsAppWebGraphQlResponse(List<BusinessCategoryNode> categories) {
    ...
    public static Optional<BizGetCategoriesV2WhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        return Optional.of(new BizGetCategoriesV2WhatsAppWebGraphQlResponse(categories));
    }
