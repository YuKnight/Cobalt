...
/**
 * The {@link ConnectionStore} holding this session's connection-runtime state.
 *
...
final class ProtobufConnectionStore implements ConnectionStore {
    /**
    ...
    @Override
    public ConnectionStore setProxy(WhatsAppClientProxy proxy) {
        this.proxy = proxy;
        return this;
    }
    ...
    @Override
    public ConnectionStore setOfflineResumeState(LinkedWhatsAppClientOfflineResumeState state) {
    ...
    @Override
    public ConnectionStore setRoutingInfo(byte[] routingInfo) {
    ...
    @Override
    public ConnectionStore setRoutingDomain(String routingDomain) {
