 ...
 * consumed through {@link LinkedAccountsGqlWhatsAppWebGraphQlResponse}.
 *
 * @see LinkedAccountsGqlWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebLinkedAccountsGQLQuery")
public final class LinkedAccountsGqlWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public LinkedAccountsGqlWhatsAppWebGraphQlRequest() {
    }
