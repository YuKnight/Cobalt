 ...
 * {@link BizCatalogManagementFetchProductWhatsAppWebGraphQlRequest} into a {@link BusinessProduct}.
 *
 ...
 *
 * @see BizCatalogManagementFetchProductWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizCatalogManagementFetchProductQuery")
public final class BizCatalogManagementFetchProductWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private BizCatalogManagementFetchProductWhatsAppWebGraphQlResponse(BusinessProduct product) {
    ...
    public static Optional<BizCatalogManagementFetchProductWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        return Optional.of(new BizCatalogManagementFetchProductWhatsAppWebGraphQlResponse(product));
    }
