 ...
 * {@link BizBroadcastBusinessInfoWhatsAppWebGraphQlRequest} into a {@link BusinessBroadcastTargetInfo}.
 *
 ...
 *
 * @see BizBroadcastBusinessInfoWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "useWAWebBizBroadcastBusinessInfoMutation")
public final class BizBroadcastBusinessInfoWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private BizBroadcastBusinessInfoWhatsAppWebGraphQlResponse(BusinessBroadcastTargetInfo businessInfo) {
     ...
     */
    public static Optional<BizBroadcastBusinessInfoWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
            return Optional.empty();
        }

        var businessInfo = readBusinessInfo(data.getJSONObject("xwa_smb_mm_business_info"));
        return Optional.of(new BizBroadcastBusinessInfoWhatsAppWebGraphQlResponse(businessInfo));
    }
     ...
     * @return the projected target info, or {@code null} when {@code node} is {@code null}
     */
     ...
     *
     * @param node the JSON object to read, possibly {@code null}
     * @return the entity identifier, or {@code null} when {@code node} is {@code null}
     */
