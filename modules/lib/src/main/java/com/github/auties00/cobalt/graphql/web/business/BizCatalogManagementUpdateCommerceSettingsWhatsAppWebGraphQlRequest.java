 ...
 * consumed through {@link BizCatalogManagementUpdateCommerceSettingsWhatsAppWebGraphQlResponse}.
 *
 * @see BizCatalogManagementUpdateCommerceSettingsWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizCatalogManagementUpdateCommerceSettingsMutation")
public final class BizCatalogManagementUpdateCommerceSettingsWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public BizCatalogManagementUpdateCommerceSettingsWhatsAppWebGraphQlRequest(Jid bizJid, boolean cartEnabled) {
        this.bizJid = bizJid;
