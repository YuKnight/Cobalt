 ...
 * {@link BizAiRuleUpdateWhatsAppWebGraphQlRequest} into a {@link BusinessAiRule}.
 *
 ...
 *
 * @see BizAiRuleUpdateWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizAiRuleUpdateMutation")
public final class BizAiRuleUpdateWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     *             no rule
     */
    private BizAiRuleUpdateWhatsAppWebGraphQlResponse(BusinessAiRule rule) {
        this.rule = rule;
    }
     ...
     */
    public static Optional<BizAiRuleUpdateWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        if (node == null || !Boolean.TRUE.equals(node.getBoolean("success"))) {
            return Optional.of(new BizAiRuleUpdateWhatsAppWebGraphQlResponse(null));
        }

        var rule = BizAiRuleProjection.of(node.getJSONObject("rule"));
        return Optional.of(new BizAiRuleUpdateWhatsAppWebGraphQlResponse(rule));
    }
