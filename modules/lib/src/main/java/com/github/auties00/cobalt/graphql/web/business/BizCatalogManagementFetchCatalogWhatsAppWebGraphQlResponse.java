 ...
 * {@link BizCatalogManagementFetchCatalogWhatsAppWebGraphQlRequest} into a {@link BusinessCatalogPage}.
 *
 ...
 *
 * @see BizCatalogManagementFetchCatalogWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizCatalogManagementFetchCatalogQuery")
public final class BizCatalogManagementFetchCatalogWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private BizCatalogManagementFetchCatalogWhatsAppWebGraphQlResponse(BusinessCatalogPage catalog) {
    ...
    public static Optional<BizCatalogManagementFetchCatalogWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        var page = new BusinessCatalogPageBuilder()
                ...
                .afterCursor(after)
                .build();
        return Optional.of(new BizCatalogManagementFetchCatalogWhatsAppWebGraphQlResponse(page));
    }
