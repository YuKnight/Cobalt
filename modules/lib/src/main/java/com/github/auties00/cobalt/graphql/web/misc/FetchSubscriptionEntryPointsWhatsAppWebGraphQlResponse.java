 ...
 * {@link FetchSubscriptionEntryPointsWhatsAppWebGraphQlRequest} into a {@link BusinessSubscriptionEntryPoints}.
 *
 ...
 *
 * @see FetchSubscriptionEntryPointsWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebFetchSubscriptionEntryPointsQuery")
public final class FetchSubscriptionEntryPointsWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private FetchSubscriptionEntryPointsWhatsAppWebGraphQlResponse(BusinessSubscriptionEntryPoints entryPoints) {
     ...
     */
    public static Optional<FetchSubscriptionEntryPointsWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        var entryPoints = new BusinessSubscriptionEntryPointsBuilder()
                ...
                .build();
        return Optional.of(new FetchSubscriptionEntryPointsWhatsAppWebGraphQlResponse(entryPoints));
    }
