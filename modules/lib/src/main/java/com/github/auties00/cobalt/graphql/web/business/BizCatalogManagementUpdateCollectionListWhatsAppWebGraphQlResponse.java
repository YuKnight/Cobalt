 ...
 * {@link BizCatalogManagementUpdateCollectionListWhatsAppWebGraphQlRequest} into a
 ...
 *
 * @see BizCatalogManagementUpdateCollectionListWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizCatalogManagementUpdateCollectionListMutation")
public final class BizCatalogManagementUpdateCollectionListWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private BizCatalogManagementUpdateCollectionListWhatsAppWebGraphQlResponse(BusinessCatalogMutationResult result) {
        this.result = result;
    }
    ...
    public static Optional<BizCatalogManagementUpdateCollectionListWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        var result = new BusinessCatalogMutationResultBuilder()
                ...
                .build();
        return Optional.of(new BizCatalogManagementUpdateCollectionListWhatsAppWebGraphQlResponse(result));
    }
