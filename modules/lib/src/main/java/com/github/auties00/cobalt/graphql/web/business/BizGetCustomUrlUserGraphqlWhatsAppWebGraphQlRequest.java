 ...
 * {@link BizGetCustomUrlUserGraphqlWhatsAppWebGraphQlResponse}.
 *
 ...
 *
 * @see BizGetCustomUrlUserGraphqlWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizGetCustomUrlUserGraphqlQuery")
public final class BizGetCustomUrlUserGraphqlWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public BizGetCustomUrlUserGraphqlWhatsAppWebGraphQlRequest(String path) {
        this.path = path;
    }
