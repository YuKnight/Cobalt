...
public interface SettingsStore {
     ...
     */
    SettingsStore setStatusPrivacy(StatusPrivacySetting statusPrivacy);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setDisappearingMode(AccountDisappearingMode disappearingMode);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setUnarchiveChats(boolean unarchiveChats);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setTwentyFourHourFormat(boolean twentyFourHourFormat);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setNewChatsEphemeralTimer(ChatEphemeralTimer newChatsEphemeralTimer);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setShowSecurityNotifications(boolean showSecurityNotifications);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setDisableLinkPreviews(boolean disableLinkPreviews);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setRelayAllCalls(boolean relayAllCalls);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setChatLockSettings(ChatLockSettings chatLockSettings);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setRecentEmojiWeights(List<RecentEmojiWeight> weights);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setTosNotices(Set<String> noticeIds);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setOptOutList(String category, String hash, List<OptOutEntry> entries);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setContactBlacklist(String category, String hash, List<Jid> entries);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore putOnboardingHintState(OnboardingHintState state);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore clearOnboardingHintStates();
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setNotificationActivitySetting(NotificationActivitySettingAction.NotificationActivitySetting setting);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setPrivateProcessingStatus(PrivateProcessingSettingAction.PrivateProcessingStatus status);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setNewsletterSubscriptionUserIdentifier(String identifier);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setNewsletterSavedInterests(String interests);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setStatusPostOptInNotificationPreferencesEnabled(Boolean enabled);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setChannelsPersonalisedRecommendationOptOut(Boolean optOut);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setStartAtLogin(boolean startAtLogin);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setMinimizeToTray(boolean minimizeToTray);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setReplaceTextWithEmoji(boolean replaceTextWithEmoji);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setBannerNotificationDisplayMode(SettingsSyncAction.DisplayMode mode);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setUnreadCounterBadgeDisplayMode(SettingsSyncAction.DisplayMode mode);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setMessagesNotificationEnabled(boolean enabled);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setCallsNotificationEnabled(boolean enabled);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setReactionsNotificationEnabled(boolean enabled);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setStatusReactionsNotificationEnabled(boolean enabled);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setTextPreviewForNotificationEnabled(boolean enabled);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setDefaultNotificationToneId(Integer toneId);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setGroupDefaultNotificationToneId(Integer toneId);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setAppTheme(AppTheme appTheme);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setWallpaperId(Integer wallpaperId);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setDoodleWallpaperEnabled(boolean enabled);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setFontSize(Integer fontSize);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setPhotosAutodownloadEnabled(boolean enabled);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setAudiosAutodownloadEnabled(boolean enabled);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setVideosAutodownloadEnabled(boolean enabled);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setDocumentsAutodownloadEnabled(boolean enabled);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setNotificationToneId(Integer toneId);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setMediaUploadQuality(SettingsSyncAction.MediaQualitySetting quality);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setSpellCheckEnabled(boolean enabled);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setEnterToSendEnabled(boolean enabled);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setGroupMessageNotificationEnabled(boolean enabled);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setGroupReactionsNotificationEnabled(boolean enabled);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setStatusNotificationEnabled(boolean enabled);
     ...
     * @return this store instance for method chaining
     */
    SettingsStore setStatusNotificationToneId(Integer toneId);
