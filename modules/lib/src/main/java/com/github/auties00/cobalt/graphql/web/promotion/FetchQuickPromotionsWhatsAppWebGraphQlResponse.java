 ...
 * {@link FetchQuickPromotionsWhatsAppWebGraphQlRequest} into a list of {@link QuickPromotionSurfaceBatch}.
 *
 ...
 *
 * @see FetchQuickPromotionsWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebFetchQuickPromotionsQuery")
public final class FetchQuickPromotionsWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private FetchQuickPromotionsWhatsAppWebGraphQlResponse(List<QuickPromotionSurfaceBatch> batches) {
     ...
     */
    public static Optional<FetchQuickPromotionsWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
            return Optional.empty();
        }

        var batches = parseBatches(data.getJSONArray("quick_promotion_batch_fetch_root"));
        return Optional.of(new FetchQuickPromotionsWhatsAppWebGraphQlResponse(batches));
    }
