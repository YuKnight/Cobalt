 ...
 * {@link BizCustomUrlGetUserGraphqlWhatsAppWebGraphQlResponse}.
 *
 * @see BizCustomUrlGetUserGraphqlWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizCustomUrlGetUserGraphqlQuery")
public final class BizCustomUrlGetUserGraphqlWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public BizCustomUrlGetUserGraphqlWhatsAppWebGraphQlRequest(String path) {
        this.path = path;
    }
