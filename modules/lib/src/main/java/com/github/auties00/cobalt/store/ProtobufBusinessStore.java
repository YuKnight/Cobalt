...
/**
 * The {@link BusinessStore} holding this session's WhatsApp Business and payments state.
 *
...
final class ProtobufBusinessStore implements BusinessStore {
    /**
    ...
    @Override
    public BusinessStore putBusinessFeatureFlag(BusinessFeatureFlag flag) {
    ...
    @Override
    public BusinessStore clearBusinessFeatureFlags() {
    ...
    @Override
    public BusinessStore putBusinessCampaignStatus(BusinessCampaignStatus status) {
    ...
    @Override
    public BusinessStore clearBusinessCampaignStatuses() {
    ...
    @Override
    public BusinessStore putBusinessSubscription(BusinessSubscription subscription) {
    ...
    @Override
    public BusinessStore clearBusinessSubscriptions() {
    ...
    @Override
    public BusinessStore setBusinessAccountNonce(String nonce) {
        nonceLock.lock();
        try {
    ...
    @Override
    public BusinessStore putCtwaDataSharing(CtwaDataSharingPreference preference) {
    ...
    @Override
    public BusinessStore clearCtwaDataSharing() {
    ...
    @Override
    public BusinessStore setBusinessPrivacySetting(String consent) {
    ...
    @Override
    public BusinessStore setBusinessOptOutListHash(String hash) {
    ...
    @Override
    public BusinessStore setHostedAutomationOnboarded(boolean onboarded) {
    ...
    @Override
    public BusinessStore setDetectedOutcomesEnabled(boolean enabled) {
    ...
    @Override
    public BusinessStore setAiAvailable(boolean aiAvailable) {
    ...
    @Override
    public BusinessStore putAgentState(AgentState state) {
    ...
    @Override
    public BusinessStore clearAgentStates() {
        agentStates.clear();
        return this;
    }
    ...
    @Override
    public BusinessStore putChatAssignment(ChatAssignment assignment) {
    ...
    @Override
    public BusinessStore clearChatAssignments() {
    ...
    @Override
    public BusinessStore setPaymentInstructionCpi(String cpi) {
    ...
    @Override
    public BusinessStore setCustomPaymentMethods(List<CustomPaymentMethod> methods) {
    ...
    @Override
    public BusinessStore setMerchantPaymentPartner(MerchantPaymentPartnerAction partner) {
    ...
    @Override
    public BusinessStore setPaymentTos(PaymentTosAction tos) {
        this.paymentTos = tos;
        return this;
    }
    ...
    @Override
    public BusinessStore putMarketingMessage(MarketingMessage message) {
    ...
    @Override
    public BusinessStore clearMarketingMessages() {
    ...
    @Override
    public BusinessStore putMarketingMessageBroadcast(MarketingMessageBroadcast broadcast) {
    ...
    @Override
    public BusinessStore clearMarketingMessageBroadcasts() {
    ...
    @Override
    public BusinessStore putBusinessBroadcastList(BusinessBroadcastList list) {
    ...
    @Override
    public BusinessStore clearBusinessBroadcastLists() {
    ...
    @Override
    public BusinessStore putBusinessBroadcastCampaign(BusinessBroadcastCampaign campaign) {
    ...
    @Override
    public BusinessStore clearBusinessBroadcastCampaigns() {
    ...
    @Override
    public BusinessStore putBusinessBroadcastInsight(BusinessBroadcastInsight insight) {
    ...
    @Override
    public BusinessStore putInteractiveMessageState(InteractiveMessageState state) {
        Objects.requireNonNull(state, "state cannot be null");
    ...
    @Override
    public BusinessStore clearInteractiveMessageStates() {
    ...
    @Override
    public BusinessStore putNoteState(NoteState state) {
        Objects.requireNonNull(state, "state cannot be null");
    ...
    @Override
    public BusinessStore clearNoteStates() {
        noteStates.clear();
        return this;
    }
    ...
    @Override
    public BusinessStore putBotWelcomeRequestState(BotWelcomeRequestState state) {
        Objects.requireNonNull(state, "state cannot be null");
    ...
    @Override
    public BusinessStore clearBotWelcomeRequestStates() {
    ...
    @Override
    public BusinessStore putAiThreadTitle(AiThreadTitle title) {
    ...
    @Override
    public BusinessStore clearAiThreadTitles() {
    ...
    @Override
    public BusinessStore setMusicUserIdState(MusicUserIdAction action) {
    ...
    @Override
    public BusinessStore setUserCreatedBotDefinition(byte[] definition) {
    ...
    @Override
    public BusinessStore setAiBusinessAgentStatus(MaibaAIFeaturesControlAction.MaibaAIFeatureStatus status) {
