 ...
 * {@link BizCatalogManagementFetchProductListWhatsAppWebGraphQlRequest} into a list of {@link BusinessProduct}.
 *
 ...
 *
 * @see BizCatalogManagementFetchProductListWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizCatalogManagementFetchProductListQuery")
public final class BizCatalogManagementFetchProductListWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private BizCatalogManagementFetchProductListWhatsAppWebGraphQlResponse(List<BusinessProduct> products) {
    ...
    public static Optional<BizCatalogManagementFetchProductListWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        return Optional.of(new BizCatalogManagementFetchProductListWhatsAppWebGraphQlResponse(products));
    }
