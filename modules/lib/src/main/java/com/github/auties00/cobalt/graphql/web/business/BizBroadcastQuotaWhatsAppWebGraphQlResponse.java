 ...
 * {@link BizBroadcastQuotaWhatsAppWebGraphQlRequest} into a {@link BusinessBroadcastQuota}.
 *
 ...
 *
 * @see BizBroadcastQuotaWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "useWAWebBizBroadcastQuotaQuery")
public final class BizBroadcastQuotaWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private BizBroadcastQuotaWhatsAppWebGraphQlResponse(BusinessBroadcastQuota quota) {
        this.quota = quota;
    }
     ...
     */
    public static Optional<BizBroadcastQuotaWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
            return Optional.empty();
        }

        var quota = readQuota(data.getJSONObject("xwa_smb_mm_quota"));
        return Optional.of(new BizBroadcastQuotaWhatsAppWebGraphQlResponse(quota));
    }
     ...
     * @return the projected quota, or {@code null} when {@code node} is {@code null}
     */
