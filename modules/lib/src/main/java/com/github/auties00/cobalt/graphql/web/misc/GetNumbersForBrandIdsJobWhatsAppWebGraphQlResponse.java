 ...
 * {@link GetNumbersForBrandIdsJobWhatsAppWebGraphQlRequest} into a list of {@link BrandPhoneNumberMapping}.
 *
 ...
 *
 * @see GetNumbersForBrandIdsJobWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebGetNumbersForBrandIdsJobQuery")
public final class GetNumbersForBrandIdsJobWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private GetNumbersForBrandIdsJobWhatsAppWebGraphQlResponse(List<BrandPhoneNumberMapping> mappings) {
     ...
     */
    public static Optional<GetNumbersForBrandIdsJobWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        return Optional.of(new GetNumbersForBrandIdsJobWhatsAppWebGraphQlResponse(parseMappings(brandIdsData)));
    }
