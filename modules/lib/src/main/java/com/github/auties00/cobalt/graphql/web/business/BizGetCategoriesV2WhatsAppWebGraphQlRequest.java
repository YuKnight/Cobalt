 ...
 * {@link BizGetCategoriesV2WhatsAppWebGraphQlResponse}.
 *
 * @see BizGetCategoriesV2WhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizGetCategoriesV2Query")
public final class BizGetCategoriesV2WhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public BizGetCategoriesV2WhatsAppWebGraphQlRequest(String query, String locale) {
        this.query = query;
        this.locale = locale;
    }
