 ...
 * {@link BizCatalogManagementAddProductWhatsAppWebGraphQlRequest} into a {@link BusinessProduct}.
 *
 ...
 *
 * @see BizCatalogManagementAddProductWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizCatalogManagementAddProductMutation")
public final class BizCatalogManagementAddProductWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private BizCatalogManagementAddProductWhatsAppWebGraphQlResponse(BusinessProduct product) {
    ...
    public static Optional<BizCatalogManagementAddProductWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        return Optional.of(new BizCatalogManagementAddProductWhatsAppWebGraphQlResponse(product));
    }
