 ...
 * {@link BizCreateOrderJobWhatsAppWebGraphQlResponse}.
 *
 * @see BizCreateOrderJobWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizCreateOrderJobMutation")
public final class BizCreateOrderJobWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     *                                      omit the field
     */
    public BizCreateOrderJobWhatsAppWebGraphQlRequest(Jid jid, List<Product> products, String directConnectionEncryptedInfo) {
        this.jid = jid;
