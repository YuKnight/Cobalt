 ...
 * {@link BizAiRuleDeleteWhatsAppWebGraphQlResponse}.
 *
 * @see BizAiRuleDeleteWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizAiRuleDeleteMutation")
public final class BizAiRuleDeleteWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     *               field
     */
    public BizAiRuleDeleteWhatsAppWebGraphQlRequest(String ruleId) {
        this.ruleId = ruleId;
    }
