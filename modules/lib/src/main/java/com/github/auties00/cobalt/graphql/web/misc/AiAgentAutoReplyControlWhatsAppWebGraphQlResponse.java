 ...
 * {@link AiAgentAutoReplyControlWhatsAppWebGraphQlRequest} into a {@link BusinessAiMutationResult}.
 *
 ...
 *
 * @see AiAgentAutoReplyControlWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebAiAgentAutoReplyControlMutation")
public final class AiAgentAutoReplyControlWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private AiAgentAutoReplyControlWhatsAppWebGraphQlResponse(BusinessAiMutationResult result) {
        this.result = result;
    }
     ...
     */
    public static Optional<AiAgentAutoReplyControlWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        var result = new BusinessAiMutationResultBuilder()
                ...
                .build();
        return Optional.of(new AiAgentAutoReplyControlWhatsAppWebGraphQlResponse(result));
    }
