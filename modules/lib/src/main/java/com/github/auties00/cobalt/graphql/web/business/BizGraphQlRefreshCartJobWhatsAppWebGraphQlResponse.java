 ...
 * {@link BizGraphQlRefreshCartJobWhatsAppWebGraphQlRequest} into a {@link BusinessRefreshedCart}.
 *
 ...
 *
 * @see BizGraphQlRefreshCartJobWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizGraphQLRefreshCartJobQuery")
public final class BizGraphQlRefreshCartJobWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private BizGraphQlRefreshCartJobWhatsAppWebGraphQlResponse(BusinessRefreshedCart cart) {
        this.cart = cart;
    }
    ...
    public static Optional<BizGraphQlRefreshCartJobWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        var cart = new BusinessRefreshedCartBuilder()
                ...
                .build();
        return Optional.of(new BizGraphQlRefreshCartJobWhatsAppWebGraphQlResponse(cart));
    }
