 ...
 * {@link BizAiRuleCreateWhatsAppWebGraphQlRequest} into a {@link BusinessAiRule}.
 *
 ...
 *
 * @see BizAiRuleCreateWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizAiRuleCreateMutation")
public final class BizAiRuleCreateWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     *             no rule
     */
    private BizAiRuleCreateWhatsAppWebGraphQlResponse(BusinessAiRule rule) {
        this.rule = rule;
    }
     ...
     */
    public static Optional<BizAiRuleCreateWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        if (node == null || !Boolean.TRUE.equals(node.getBoolean("success"))) {
            return Optional.of(new BizAiRuleCreateWhatsAppWebGraphQlResponse(null));
        }

        var rule = BizAiRuleProjection.of(node.getJSONObject("rule"));
        return Optional.of(new BizAiRuleCreateWhatsAppWebGraphQlResponse(rule));
    }
