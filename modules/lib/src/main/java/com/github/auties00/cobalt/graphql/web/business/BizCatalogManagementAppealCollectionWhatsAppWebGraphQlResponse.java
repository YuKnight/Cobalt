 ...
 * {@link BizCatalogManagementAppealCollectionWhatsAppWebGraphQlRequest} into a
 ...
 *
 * @see BizCatalogManagementAppealCollectionWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizCatalogManagementAppealCollectionMutation")
public final class BizCatalogManagementAppealCollectionWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private BizCatalogManagementAppealCollectionWhatsAppWebGraphQlResponse(BusinessCatalogMutationResult result) {
        this.result = result;
    }
    ...
    public static Optional<BizCatalogManagementAppealCollectionWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        var result = new BusinessCatalogMutationResultBuilder()
                ...
                .build();
        return Optional.of(new BizCatalogManagementAppealCollectionWhatsAppWebGraphQlResponse(result));
    }
