 ...
 * {@link QueryCatalogProductWhatsAppWebGraphQlResponse}.
 *
 * @see QueryCatalogProductWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebQueryCatalogProductQuery")
public final class QueryCatalogProductWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     *                                      {@code null} when not requested
     */
    public QueryCatalogProductWhatsAppWebGraphQlRequest(Jid jid, String productId, Integer width, Integer height,
