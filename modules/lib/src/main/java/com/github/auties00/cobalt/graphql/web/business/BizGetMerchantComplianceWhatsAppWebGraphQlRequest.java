 ...
 * {@link BizGetMerchantComplianceWhatsAppWebGraphQlResponse}.
 *
 * @see BizGetMerchantComplianceWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizGetMerchantComplianceQuery")
public final class BizGetMerchantComplianceWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public BizGetMerchantComplianceWhatsAppWebGraphQlRequest(Jid bizJid) {
        this.bizJid = bizJid;
    }
