 ...
 * {@link BizCatalogManagementDeleteCollectionsWhatsAppWebGraphQlResponse}.
 *
 * @see BizCatalogManagementDeleteCollectionsWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizCatalogManagementDeleteCollectionsMutation")
public final class BizCatalogManagementDeleteCollectionsWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     *                         field
     */
    public BizCatalogManagementDeleteCollectionsWhatsAppWebGraphQlRequest(List<String> collectionIds, Jid bizJid, String catalogSessionId) {
