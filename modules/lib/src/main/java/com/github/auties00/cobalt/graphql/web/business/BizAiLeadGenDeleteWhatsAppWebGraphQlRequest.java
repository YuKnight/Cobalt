 ...
 * the {@code XFBMetaAIBusinessAgentWhatsAppLeadGenFlow} node, not a WhatsApp address). The relay
 * returns the deletion outcome under {@code xfb_meta_ai_biz_agent_wa_delete_lead_gen_flow}; the reply
 * is consumed through {@link BizAiLeadGenDeleteWhatsAppWebGraphQlResponse}.
 *
 * @see BizAiLeadGenDeleteWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizAiLeadGenDeleteMutation")
public final class BizAiLeadGenDeleteWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public BizAiLeadGenDeleteWhatsAppWebGraphQlRequest(String flowId) {
        this.flowId = flowId;
    }
