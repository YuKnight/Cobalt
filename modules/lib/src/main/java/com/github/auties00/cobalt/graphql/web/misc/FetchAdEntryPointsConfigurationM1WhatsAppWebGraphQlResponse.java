 ...
 * {@link FetchAdEntryPointsConfigurationM1WhatsAppWebGraphQlRequest} into a list of {@link AdEntryPointEntitlement}.
 *
 ...
 *
 * @see FetchAdEntryPointsConfigurationM1WhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebFetchAdEntryPointsConfigurationM1Query")
public final class FetchAdEntryPointsConfigurationM1WhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private FetchAdEntryPointsConfigurationM1WhatsAppWebGraphQlResponse(List<AdEntryPointEntitlement> entitlements) {
     ...
     */
    public static Optional<FetchAdEntryPointsConfigurationM1WhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
            return Optional.empty();
        }

        var entitlements = parseEntitlements(data.getJSONArray("ctwa_client_entry_point_entitlement"));
        return Optional.of(new FetchAdEntryPointsConfigurationM1WhatsAppWebGraphQlResponse(entitlements));
    }
