...
/**
 * Parses the WhatsApp Web GraphQL response of the price-tiers query built by {@link BizGetPriceTiersWhatsAppWebGraphQlRequest}
 ...
 * model.
 *
 * @see BizGetPriceTiersWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizGetPriceTiersQuery")
public final class BizGetPriceTiersWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private BizGetPriceTiersWhatsAppWebGraphQlResponse(List<BusinessPriceTier> priceTiers) {
    ...
    public static Optional<BizGetPriceTiersWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        return Optional.of(new BizGetPriceTiersWhatsAppWebGraphQlResponse(priceTiers));
    }
