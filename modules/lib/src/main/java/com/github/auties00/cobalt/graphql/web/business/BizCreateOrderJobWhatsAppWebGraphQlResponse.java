 ...
 * {@link BizCreateOrderJobWhatsAppWebGraphQlRequest} into a {@link BusinessOrder}.
 *
 ...
 *
 * @see BizCreateOrderJobWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizCreateOrderJobMutation")
public final class BizCreateOrderJobWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private BizCreateOrderJobWhatsAppWebGraphQlResponse(BusinessOrder order) {
        this.order = order;
    }
    ...
    public static Optional<BizCreateOrderJobWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        var order = new BusinessOrderBuilder()
                ...
                .total(total)
                .build();
        return Optional.of(new BizCreateOrderJobWhatsAppWebGraphQlResponse(order));
    }
