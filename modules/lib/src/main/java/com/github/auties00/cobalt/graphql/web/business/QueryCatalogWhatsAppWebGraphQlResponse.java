...
/**
 * Parses the WhatsApp Web GraphQL response of the catalog-products query built by {@link QueryCatalogWhatsAppWebGraphQlRequest}.
 *
 ...
 *
 * @see QueryCatalogWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebQueryCatalogQuery")
public final class QueryCatalogWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     *                    no further pages
     */
    private QueryCatalogWhatsAppWebGraphQlResponse(List<BusinessCatalogEntry> products, String afterCursor) {
    ...
    public static Optional<QueryCatalogWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
            return Optional.empty();
        }
        var getResult = data.getJSONObject("xwa_product_catalog_get_product_catalog");
        if (getResult == null) {
            return Optional.of(new QueryCatalogWhatsAppWebGraphQlResponse(List.of(), ""));
        }
        ...
        return Optional.of(new QueryCatalogWhatsAppWebGraphQlResponse(products, cursor));
    }
     ...
     * {@link QueryCatalogWhatsAppWebGraphQlRequest}. An empty {@link Optional} means the relay did not advertise a
