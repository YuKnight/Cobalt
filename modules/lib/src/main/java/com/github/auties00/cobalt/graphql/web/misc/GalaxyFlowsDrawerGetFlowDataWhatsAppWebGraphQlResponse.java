 ...
 * {@link GalaxyFlowsDrawerGetFlowDataWhatsAppWebGraphQlRequest} into a {@link BusinessFlowMetadata}.
 *
 ...
 *
 * @see GalaxyFlowsDrawerGetFlowDataWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebGalaxyFlowsDrawerGetFlowDataQuery")
public final class GalaxyFlowsDrawerGetFlowDataWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private GalaxyFlowsDrawerGetFlowDataWhatsAppWebGraphQlResponse(BusinessFlowMetadata metadata) {
     ...
     */
    public static Optional<GalaxyFlowsDrawerGetFlowDataWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        var metadata = new BusinessFlowMetadataBuilder()
                ...
                .build();
        return Optional.of(new GalaxyFlowsDrawerGetFlowDataWhatsAppWebGraphQlResponse(metadata));
    }
