 ...
 * through {@link BizCatalogManagementDeleteProductWhatsAppWebGraphQlResponse}.
 *
 * @see BizCatalogManagementDeleteProductWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizCatalogManagementDeleteProductMutation")
public final class BizCatalogManagementDeleteProductWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public BizCatalogManagementDeleteProductWhatsAppWebGraphQlRequest(Jid bizJid, List<String> productIds) {
        this.bizJid = bizJid;
