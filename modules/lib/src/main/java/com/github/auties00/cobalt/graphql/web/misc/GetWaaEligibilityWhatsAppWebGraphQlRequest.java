 ...
 * {@link GetWaaEligibilityWhatsAppWebGraphQlResponse}.
 *
 * @see GetWaaEligibilityWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebGetWAAEligibilityQuery")
public final class GetWaaEligibilityWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public GetWaaEligibilityWhatsAppWebGraphQlRequest(String flowId, Instant requestId) {
        this.flowId = flowId;
