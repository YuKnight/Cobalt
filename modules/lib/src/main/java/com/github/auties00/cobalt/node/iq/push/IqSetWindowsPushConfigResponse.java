...
public sealed interface IqSetWindowsPushConfigResponse extends IqOperation.Response
    ...
    @WhatsAppWebExport(moduleName = "WAWebSetWindowsPushConfig",
            exports = "setWindowsPushConfig", adaptation = WhatsAppAdaptation.ADAPTED)
    static Optional<? extends IqSetWindowsPushConfigResponse> of(Node node, Node request) {
    ...
    final class Success implements IqSetWindowsPushConfigResponse {
        /**
         ...
         */
        @WhatsAppWebExport(moduleName = "WAWebSetWindowsPushConfig",
                exports = "setPushConfig", adaptation = WhatsAppAdaptation.ADAPTED)
        ...
        public String toString() {
            return "IqSetWindowsPushConfigResponse.Success[]";
        }
    }
     ...
     */
    @WhatsAppWebModule(moduleName = "WAWebSetWindowsPushConfig")
    final class ClientError implements IqSetWindowsPushConfigResponse {
        /**
        ...
        @Override
        public String toString() {
            return "IqSetWindowsPushConfigResponse.ClientError[errorCode=" + errorCode
                    + ", errorText=" + errorText + ']';
        }
    }
     ...
     */
    @WhatsAppWebModule(moduleName = "WAWebSetWindowsPushConfig")
    final class ServerError implements IqSetWindowsPushConfigResponse {
        /**
         * The numeric server-side error code.
         */
        private final int errorCode;
        ...
        @Override
        public String toString() {
            return "IqSetWindowsPushConfigResponse.ServerError[errorCode=" + errorCode
                    + ", errorText=" + errorText + ']';
        }
    }
}
