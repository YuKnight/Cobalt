 ...
 * {@link BizCatalogManagementAddProductWhatsAppWebGraphQlResponse}.
 *
 ...
 *
 * @see BizCatalogManagementAddProductWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizCatalogManagementAddProductMutation")
public final class BizCatalogManagementAddProductWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     *                        omit the field
     */
    public BizCatalogManagementAddProductWhatsAppWebGraphQlRequest(Jid bizJid, Integer width, Integer height, String productInfoJson) {
        this.bizJid = bizJid;
        this.width = width;
        this.height = height;
