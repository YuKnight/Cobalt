 ...
 * {@link BizProfileAddressAutocompleteWhatsAppWebGraphQlResponse}.
 *
 ...
 * construction.
 *
 * @see BizProfileAddressAutocompleteWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizProfileAddressAutocompleteQuery")
public final class BizProfileAddressAutocompleteWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     *                  variable
     */
    public BizProfileAddressAutocompleteWhatsAppWebGraphQlRequest(String inputJson) {
