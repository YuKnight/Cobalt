...
public sealed interface IqClearDirtyBitsResponse extends IqOperation.Response
    ...
    /**
     * Tries each {@link IqClearDirtyBitsResponse} variant in priority order and returns
     ...
     * dirty-bit clear as malformed or unauthorised.
     */
    @WhatsAppWebModule(moduleName = "WAWebClearDirtyBitsJob")
     ...
     * transient internal failure while processing the dirty-bit clear.
     */
    @WhatsAppWebModule(moduleName = "WAWebClearDirtyBitsJob")
