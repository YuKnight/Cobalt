 ...
 * {@link BizAiKnowledgeReviewWhatsAppWebGraphQlRequest} into a {@link BusinessAiKnowledgeReview}.
 *
 ...
 * operator's approval.
 *
 * @see BizAiKnowledgeReviewWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizAiKnowledgeReviewQuery")
public final class BizAiKnowledgeReviewWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     *                        field
     */
    private BizAiKnowledgeReviewWhatsAppWebGraphQlResponse(BusinessAiKnowledgeReview knowledgeReview) {
     ...
     */
    public static Optional<BizAiKnowledgeReviewWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        if (review == null) {
            return Optional.of(new BizAiKnowledgeReviewWhatsAppWebGraphQlResponse(null));
        }
        ...
        var knowledgeReview = new BusinessAiKnowledgeReviewBuilder()
                ...
                .build();
        return Optional.of(new BizAiKnowledgeReviewWhatsAppWebGraphQlResponse(knowledgeReview));
    }
