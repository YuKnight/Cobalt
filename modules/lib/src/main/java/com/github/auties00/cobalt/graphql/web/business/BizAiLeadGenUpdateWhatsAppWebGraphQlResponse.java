 ...
 * {@link BizAiLeadGenUpdateWhatsAppWebGraphQlRequest} into a {@link BusinessAiLeadGenForm}.
 *
 ...
 *
 * @see BizAiLeadGenUpdateWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizAiLeadGenUpdateMutation")
public final class BizAiLeadGenUpdateWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     *             reported failure
     */
    private BizAiLeadGenUpdateWhatsAppWebGraphQlResponse(BusinessAiLeadGenForm form) {
        this.form = form;
    }
     ...
     */
    public static Optional<BizAiLeadGenUpdateWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        return Optional.of(new BizAiLeadGenUpdateWhatsAppWebGraphQlResponse(form));
    }
