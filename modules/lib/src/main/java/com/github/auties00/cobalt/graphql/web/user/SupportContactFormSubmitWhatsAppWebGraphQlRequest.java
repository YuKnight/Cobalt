package com.github.auties00.cobalt.graphql.web.user;
...
public final class SupportContactFormSubmitWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
     ...
     */
    public SupportContactFormSubmitWhatsAppWebGraphQlRequest(String description, String debugInfoJson, String contextFlow) {
