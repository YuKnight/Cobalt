...
/**
 * The protobuf-backed {@link SignalStore} holding this session's Signal-protocol cryptographic state.
 *
...
public final class ProtobufSignalStore implements SignalStore {
    /**
    ...
    @Override
    public SignalStore setSignedDeviceIdentity(ADVSignedDeviceIdentity signedDeviceIdentity) {
        this.signedDeviceIdentity = signedDeviceIdentity;
        return this;
    }
    ...
    @Override
    public SignalStore setAdvSecretKey(byte[] advSecretKey) {
        this.advSecretKey = advSecretKey;
        return this;
    }
     ...
     * is the account's own Signal address (resolved through the bound {@link AccountStore}), and
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ProtobufSignalStore that)) {
            return false;
        }
