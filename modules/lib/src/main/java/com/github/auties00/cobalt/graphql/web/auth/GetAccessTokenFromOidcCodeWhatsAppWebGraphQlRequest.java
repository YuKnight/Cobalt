 ...
 * consumed through {@link GetAccessTokenFromOidcCodeWhatsAppWebGraphQlResponse}.
 *
 * @see GetAccessTokenFromOidcCodeWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebGetAccessTokenFromOIDCCodeMutation")
public final class GetAccessTokenFromOidcCodeWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public GetAccessTokenFromOidcCodeWhatsAppWebGraphQlRequest(String code, String state) {
        this.code = code;
        this.state = state;
    }
