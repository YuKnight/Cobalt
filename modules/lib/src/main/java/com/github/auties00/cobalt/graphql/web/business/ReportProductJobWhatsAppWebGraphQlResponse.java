 ...
 * {@link ReportProductJobWhatsAppWebGraphQlRequest} into the report-accepted flag.
 *
 ...
 *
 * @see ReportProductJobWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebReportProductJobMutation")
public final class ReportProductJobWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private ReportProductJobWhatsAppWebGraphQlResponse(boolean accepted) {
    ...
    public static Optional<ReportProductJobWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
            return Optional.empty();
        }
        var root = data.getJSONObject("xwa_whatsapp_catalog_report_product");
        var success = root == null ? null : root.getBoolean("success");
        return Optional.of(new ReportProductJobWhatsAppWebGraphQlResponse(success != null && success));
    }
