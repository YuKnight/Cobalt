 ...
 * {@link BizBroadcastGenAiRecommendationJobWhatsAppWebGraphQlRequest} into a
 ...
 * left empty.
 *
 * @see BizBroadcastGenAiRecommendationJobWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizBroadcastGenAIRecommendationJobQuery")
public final class BizBroadcastGenAiRecommendationJobWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     *                       field
     */
    private BizBroadcastGenAiRecommendationJobWhatsAppWebGraphQlResponse(BusinessBroadcastGenAiRecommendation recommendation) {
     ...
     */
    public static Optional<BizBroadcastGenAiRecommendationJobWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
            return Optional.empty();
        }

        var recommendation = readRecommendation(data.getJSONObject("xwa_business_broadcast_genai_recommendation"));
        return Optional.of(new BizBroadcastGenAiRecommendationJobWhatsAppWebGraphQlResponse(recommendation));
    }
     ...
     * @return the projected recommendation, or {@code null} when {@code node} is {@code null} or no
     ...
     *
     * @param node the JSON object to read, possibly {@code null}
     * @return the projected pair, or {@code null} when {@code node} is {@code null}
     */
