...
/**
 * Parses the WhatsApp Web GraphQL response of the query-order query built by {@link BizQueryOrderJobWhatsAppWebGraphQlRequest}.
 *
 ...
 * {@code WapParser} is intentionally not implemented (see {@link BizQueryOrderJobWhatsAppWebGraphQlRequest}). The
 ...
 *
 * @see BizQueryOrderJobWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizQueryOrderJobQuery")
public final class BizQueryOrderJobWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private BizQueryOrderJobWhatsAppWebGraphQlResponse(BusinessOrder order) {
        this.order = order;
    }
    ...
    public static Optional<BizQueryOrderJobWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        var order = new BusinessOrderBuilder()
                ...
                .items(products)
                .build();
        return Optional.of(new BizQueryOrderJobWhatsAppWebGraphQlResponse(order));
    }
