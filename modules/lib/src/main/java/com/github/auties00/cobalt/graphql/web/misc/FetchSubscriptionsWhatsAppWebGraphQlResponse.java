 ...
 * {@link FetchSubscriptionsWhatsAppWebGraphQlRequest} into a {@link BusinessSubscriptions}.
 *
 ...
 *
 * @see FetchSubscriptionsWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebFetchSubscriptionsQuery")
public final class FetchSubscriptionsWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private FetchSubscriptionsWhatsAppWebGraphQlResponse(BusinessSubscriptions subscriptions) {
     ...
     */
    public static Optional<FetchSubscriptionsWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        var subscriptions = new BusinessSubscriptionsBuilder()
                ...
                .build();
        return Optional.of(new FetchSubscriptionsWhatsAppWebGraphQlResponse(subscriptions));
    }
