 ...
 * {@link BizAdCreationLwiMediaUploadWhatsAppWebGraphQlResponse}.
 *
 * @see BizAdCreationLwiMediaUploadWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizAdCreationLWIMediaUploadMutation")
public final class BizAdCreationLwiMediaUploadWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public BizAdCreationLwiMediaUploadWhatsAppWebGraphQlRequest(String adAccountId, String pageId, List<String> mediaIds, String fbAccessToken) {
