 ...
 * {@link LinkedNewMessageListener}) directly with a lambda.
 *
 * <p>Listeners are registered via
 * {@link LinkedWhatsAppClient#addListener(WhatsAppLinkedListener)} and can be
 * removed with
 * {@link LinkedWhatsAppClient#removeListener(WhatsAppLinkedListener)}. Each
 ...
 * @see LinkedWhatsAppClient#addListener(WhatsAppLinkedListener)
 * @see LinkedWhatsAppClient#removeListener(WhatsAppLinkedListener)
 */
public non-sealed interface LinkedWhatsAppClientListener extends WhatsAppLinkedListener, LinkedNodeSentListener,
