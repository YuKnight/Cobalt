 ...
 * {@link BizAiAbilitiesWhatsAppWebGraphQlRequest} into a {@link BusinessAiAgentHome}.
 *
 ...
 *
 * @see BizAiAbilitiesWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizAiAbilitiesQuery")
public final class BizAiAbilitiesWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private BizAiAbilitiesWhatsAppWebGraphQlResponse(BusinessAiAgentHome agentHome) {
     ...
     */
    public static Optional<BizAiAbilitiesWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        if (home == null) {
            return Optional.of(new BizAiAbilitiesWhatsAppWebGraphQlResponse(null));
        }
        ...
        var agentHome = new BusinessAiAgentHomeBuilder()
                .abilities(abilities)
                .build();
        return Optional.of(new BizAiAbilitiesWhatsAppWebGraphQlResponse(agentHome));
    }
