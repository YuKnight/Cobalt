 ...
 * reply is consumed through {@link GraphQlProductCatalogGetPublicKeyJobWhatsAppWebGraphQlResponse}.
 *
 * @see GraphQlProductCatalogGetPublicKeyJobWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebGraphQLProductCatalogGetPublicKeyJobQuery")
public final class GraphQlProductCatalogGetPublicKeyJobWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public GraphQlProductCatalogGetPublicKeyJobWhatsAppWebGraphQlRequest(Jid bizJid) {
        this.bizJid = bizJid;
    }
