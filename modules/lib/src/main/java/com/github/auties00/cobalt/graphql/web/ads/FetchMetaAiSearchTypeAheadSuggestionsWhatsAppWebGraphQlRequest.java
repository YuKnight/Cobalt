 ...
 * the reply is consumed through {@link FetchMetaAiSearchTypeAheadSuggestionsWhatsAppWebGraphQlResponse}.
 *
 * @see FetchMetaAiSearchTypeAheadSuggestionsWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebFetchMetaAISearchTypeAheadSuggestionsQuery")
public final class FetchMetaAiSearchTypeAheadSuggestionsWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public FetchMetaAiSearchTypeAheadSuggestionsWhatsAppWebGraphQlRequest(String query, String locale, List<Integer> expConfig, List<String> capabilities) {
        this.query = query;
        this.locale = locale;
