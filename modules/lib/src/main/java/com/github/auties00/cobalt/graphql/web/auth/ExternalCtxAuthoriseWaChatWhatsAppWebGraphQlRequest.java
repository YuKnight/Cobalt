 ...
 * {@link ExternalCtxAuthoriseWaChatWhatsAppWebGraphQlResponse}.
 *
 * @see ExternalCtxAuthoriseWaChatWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebExternalCtxAuthoriseWAChatMutation")
public final class ExternalCtxAuthoriseWaChatWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     *                     field
     */
    public ExternalCtxAuthoriseWaChatWhatsAppWebGraphQlRequest(Jid recipientJid, String deeplinkType, Boolean external, String partnerToken) {
