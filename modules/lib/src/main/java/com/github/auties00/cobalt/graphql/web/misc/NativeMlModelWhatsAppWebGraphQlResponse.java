 ...
 * {@link NativeMlModelWhatsAppWebGraphQlRequest} into a {@link NativeMachineLearningModelManifest}.
 *
 ...
 *
 * @see NativeMlModelWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebNativeMLModelQuery")
public final class NativeMlModelWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private NativeMlModelWhatsAppWebGraphQlResponse(NativeMachineLearningModelManifest manifest) {
     ...
     */
    public static Optional<NativeMlModelWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        var manifest = new NativeMachineLearningModelManifestBuilder()
                ...
                .build();
        return Optional.of(new NativeMlModelWhatsAppWebGraphQlResponse(manifest));
    }
