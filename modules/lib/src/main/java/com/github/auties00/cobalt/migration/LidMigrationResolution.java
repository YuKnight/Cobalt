 ...
 *     <li>{@link Keep} - Thread will remain unchanged (already LID, group, broadcast, etc.)</li>
 *     <li>{@link Delete} - Thread will be deleted (no LID mapping available for a deletable chat)</li>
 * </ul>
 *
 * @implNote WAWebLid1X1ThreadAccountMigrations.getResolvedThreadAccountLid — maps to the
 *           result types: {@code {threadLid}} -> Migrate, LID/non-regular -> Keep,
 *           {@code {deleteChat: true}} -> Delete, {@code {logoutReason}} -> throws
 */
