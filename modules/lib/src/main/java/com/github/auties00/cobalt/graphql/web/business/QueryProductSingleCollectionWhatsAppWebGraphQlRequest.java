 ...
 * through {@link QueryProductSingleCollectionWhatsAppWebGraphQlResponse}.
 *
 * @see QueryProductSingleCollectionWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebQueryProductSingleCollectionQuery")
public final class QueryProductSingleCollectionWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     *                                      {@code null} to omit the field
     */
    public QueryProductSingleCollectionWhatsAppWebGraphQlRequest(Jid catalogJid, String collectionId, Integer limit, String afterCursor, Integer width, Integer height, String directConnectionEncryptedInfo, String variantInfoFields, Integer variantThumbnailHeight, Integer variantThumbnailWidth) {
