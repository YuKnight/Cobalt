 ...
 * {@link WaffleXeWhatsAppWebGraphQlRequest} into a {@link CrossPostingEligibility}.
 *
 ...
 *
 * @see WaffleXeWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebWaffleXEQuery")
public final class WaffleXeWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     *                    field
     */
    private WaffleXeWhatsAppWebGraphQlResponse(CrossPostingEligibility eligibility) {
     ...
     */
    public static Optional<WaffleXeWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        var eligibility = new CrossPostingEligibilityBuilder()
                ...
                .build();
        return Optional.of(new WaffleXeWhatsAppWebGraphQlResponse(eligibility));
    }
