 ...
 * {@link BizBroadcastBillingInfoWhatsAppWebGraphQlRequest} into a {@link BusinessBroadcastBillingAccount}.
 *
 ...
 *
 * @see BizBroadcastBillingInfoWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "useWAWebBizBroadcastBillingInfoQuery")
public final class BizBroadcastBillingInfoWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     *                        field
     */
    private BizBroadcastBillingInfoWhatsAppWebGraphQlResponse(BusinessBroadcastBillingAccount billableAccount) {
     ...
     */
    public static Optional<BizBroadcastBillingInfoWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
            return Optional.empty();
        }

        var billableAccount = readBillableAccount(data.getJSONObject("billable_account_by_asset_id"));
        return Optional.of(new BizBroadcastBillingInfoWhatsAppWebGraphQlResponse(billableAccount));
    }
     ...
     * @return the projected billable account, or {@code null} when {@code node} is {@code null}
     */
     ...
     *
     * @param node the JSON object to read, possibly {@code null}
     * @return the projected billing info, or {@code null} when {@code node} is {@code null}
     */
     ...
     *
     * @param node the JSON object to read, possibly {@code null}
     * @return the projected estimated tax, or {@code null} when {@code node} is {@code null}
     */
     ...
     *
     * @param node the JSON object to read, possibly {@code null}
     * @return the projected tax line item, or {@code null} when {@code node} is {@code null}
     */
     ...
     *
     * @param node the JSON object to read, possibly {@code null}
     * @return the projected currency amount, or {@code null} when {@code node} is {@code null}
     */
     ...
     *
     * @param node the JSON object to read, possibly {@code null}
     * @return the projected payment-section details, or {@code null} when {@code node} is {@code null}
     */
     ...
     *
     * @param node the JSON object to read, possibly {@code null}
     * @return the projected image, or {@code null} when {@code node} is {@code null}
     */
     ...
     *
     * @param node the JSON object to read, possibly {@code null}
     * @return the projected required action, or {@code null} when {@code node} is {@code null}
     */
     ...
     *
     * @param node the JSON object to read, possibly {@code null}
     * @return the projected action, or {@code null} when {@code node} is {@code null}
     */
     ...
     *
     * @param node the JSON object to read, possibly {@code null}
     * @return the projected message, or {@code null} when {@code node} is {@code null}
     */
