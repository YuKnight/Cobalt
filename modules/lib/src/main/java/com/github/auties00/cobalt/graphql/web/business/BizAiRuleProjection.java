 ...
 * centralises the flattening of a rule node (its identifier, kind, custom-instruction text, and the
...
final class BizAiRuleProjection {
    ...
    /**
     * Projects a single {@code rule} node onto a {@link BusinessAiRule}.
     *
     * @param obj the rule node, possibly {@code null}
