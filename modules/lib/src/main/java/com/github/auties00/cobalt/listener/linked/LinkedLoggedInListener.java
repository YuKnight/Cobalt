 ...
 */
@FunctionalInterface
public non-sealed interface LinkedLoggedInListener extends WhatsAppLinkedListener {
    /**
     ...
     * {@link LinkedChatsListener#onChats onChats} and
     * {@link LinkedContactsListener#onContacts onContacts}.
     *
