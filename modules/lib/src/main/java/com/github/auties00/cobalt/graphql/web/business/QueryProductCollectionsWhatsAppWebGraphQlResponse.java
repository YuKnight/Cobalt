 ...
 * {@link QueryProductCollectionsWhatsAppWebGraphQlRequest}.
 *
 ...
 *
 * @see QueryProductCollectionsWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebQueryProductCollectionsQuery")
public final class QueryProductCollectionsWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     *                    no further pages
     */
    private QueryProductCollectionsWhatsAppWebGraphQlResponse(List<BusinessCatalog> collections, String afterCursor) {
    ...
    public static Optional<QueryProductCollectionsWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
            return Optional.empty();
        }
        var getResult = data.getJSONObject("xwa_product_catalog_get_collections");
        if (getResult == null) {
            return Optional.of(new QueryProductCollectionsWhatsAppWebGraphQlResponse(List.of(), ""));
        }
        ...
        return Optional.of(new QueryProductCollectionsWhatsAppWebGraphQlResponse(collections, cursor));
    }
     ...
     * {@link QueryProductCollectionsWhatsAppWebGraphQlRequest}. An empty {@link Optional} means the relay did not
