 ...
 * the reply is consumed through {@link GetFbAccountPagesWhatsAppWebGraphQlResponse}.
 *
 * @see GetFbAccountPagesWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebGetFBAccountPagesQuery")
public final class GetFbAccountPagesWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public GetFbAccountPagesWhatsAppWebGraphQlRequest(String userId) {
        this.userId = userId;
    }
