 ...
 * {@link BizCatalogManagementUpdateCollectionListWhatsAppWebGraphQlResponse}.
 *
 * @see BizCatalogManagementUpdateCollectionListWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizCatalogManagementUpdateCollectionListMutation")
public final class BizCatalogManagementUpdateCollectionListWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public BizCatalogManagementUpdateCollectionListWhatsAppWebGraphQlRequest(Jid bizJid, List<Move> moves) {
        this.bizJid = bizJid;
        this.moves = moves;
    }
