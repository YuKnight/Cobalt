 ...
 * {@code xfb_wa_biz_get_oidc_state}. The reply is consumed through {@link FetchOidcStateWhatsAppWebGraphQlResponse}.
 *
 * @see FetchOidcStateWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebFetchOIDCStateQuery")
public final class FetchOidcStateWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public FetchOidcStateWhatsAppWebGraphQlRequest() {
    }
