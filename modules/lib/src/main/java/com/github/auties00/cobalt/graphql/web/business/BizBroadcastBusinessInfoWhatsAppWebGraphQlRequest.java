 ...
 * id. The reply is consumed through {@link BizBroadcastBusinessInfoWhatsAppWebGraphQlResponse}.
 *
 ...
 * construction.
 *
 * @see BizBroadcastBusinessInfoWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "useWAWebBizBroadcastBusinessInfoMutation")
public final class BizBroadcastBusinessInfoWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     *                  variable
     */
    public BizBroadcastBusinessInfoWhatsAppWebGraphQlRequest(String inputJson) {
