 ...
 * is consumed through {@link BizAiReplyBotEnabledTimeUpdateWhatsAppWebGraphQlResponse}.
 *
 ...
 *
 * @see BizAiReplyBotEnabledTimeUpdateWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizAiReplyBotEnabledTimeUpdateMutation")
public final class BizAiReplyBotEnabledTimeUpdateWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     *                     omit the field
     */
    public BizAiReplyBotEnabledTimeUpdateWhatsAppWebGraphQlRequest(Boolean enabledTime, String timeZone, Integer fromSecInDay, Integer toSecInDay) {
