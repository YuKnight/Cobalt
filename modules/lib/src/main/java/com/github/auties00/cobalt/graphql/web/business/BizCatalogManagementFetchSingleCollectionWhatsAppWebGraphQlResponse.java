 ...
 * {@link BizCatalogManagementFetchSingleCollectionWhatsAppWebGraphQlRequest} into a
 ...
 *
 * @see BizCatalogManagementFetchSingleCollectionWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizCatalogManagementFetchSingleCollectionQuery")
public final class BizCatalogManagementFetchSingleCollectionWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private BizCatalogManagementFetchSingleCollectionWhatsAppWebGraphQlResponse(BusinessProductCollection collection) {
    ...
    public static Optional<BizCatalogManagementFetchSingleCollectionWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        var collection = new BusinessProductCollectionBuilder()
                ...
                .afterCursor(after)
                .build();
        return Optional.of(new BizCatalogManagementFetchSingleCollectionWhatsAppWebGraphQlResponse(collection));
    }
