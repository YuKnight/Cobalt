 ...
 * through {@link BizAiLeadGenUpdateWhatsAppWebGraphQlResponse}.
 *
 ...
 *
 * @see BizAiLeadGenUpdateWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizAiLeadGenUpdateMutation")
public final class BizAiLeadGenUpdateWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     *                    variable
     */
    public BizAiLeadGenUpdateWhatsAppWebGraphQlRequest(String requestJson) {
