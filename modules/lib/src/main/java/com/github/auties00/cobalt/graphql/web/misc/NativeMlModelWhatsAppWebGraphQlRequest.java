 ...
 * {@link NativeMlModelWhatsAppWebGraphQlResponse}.
 *
 ...
 *
 * @see NativeMlModelWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebNativeMLModelQuery")
public final class NativeMlModelWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public NativeMlModelWhatsAppWebGraphQlRequest(String modelRequestMetadatasJson, String clientCapabilityMetadataJson) {
