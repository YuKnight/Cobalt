...
/**
 * The protobuf-backed {@link SettingsStore} holding this session's user-preference and settings state.
 *
...
public final class ProtobufSettingsStore implements SettingsStore {
    /**
    ...
    @Override
    public SettingsStore setStatusPrivacy(StatusPrivacySetting statusPrivacy) {
    ...
    @Override
    public SettingsStore setDisappearingMode(AccountDisappearingMode disappearingMode) {
    ...
    @Override
    public SettingsStore setUnarchiveChats(boolean unarchiveChats) {
        this.unarchiveChats = unarchiveChats;
        return this;
    }
    ...
    @Override
    public SettingsStore setTwentyFourHourFormat(boolean twentyFourHourFormat) {
        this.twentyFourHourFormat = twentyFourHourFormat;
        return this;
    }
    ...
    @Override
    public SettingsStore setNewChatsEphemeralTimer(ChatEphemeralTimer newChatsEphemeralTimer) {
    ...
    @Override
    public SettingsStore setShowSecurityNotifications(boolean showSecurityNotifications) {
        this.showSecurityNotifications = showSecurityNotifications;
        return this;
    }
    ...
    @Override
    public SettingsStore setDisableLinkPreviews(boolean disableLinkPreviews) {
        this.disableLinkPreviews = disableLinkPreviews;
        return this;
    }
    ...
    @Override
    public SettingsStore setRelayAllCalls(boolean relayAllCalls) {
        this.relayAllCalls = relayAllCalls;
        return this;
    }
    ...
    @Override
    public SettingsStore setChatLockSettings(ChatLockSettings chatLockSettings) {
        this.chatLockSettings = chatLockSettings;
        return this;
    }
    ...
    @Override
    public SettingsStore setRecentEmojiWeights(List<RecentEmojiWeight> weights) {
    ...
    @Override
    public SettingsStore setTosNotices(Set<String> noticeIds) {
    ...
    @Override
    public SettingsStore setOptOutList(String category, String hash, List<OptOutEntry> entries) {
    ...
    @Override
    public SettingsStore setContactBlacklist(String category, String hash, List<Jid> entries) {
        Objects.requireNonNull(category, "category cannot be null");
        Objects.requireNonNull(entries, "entries cannot be null");
        if (hash == null) {
    ...
    @Override
    public SettingsStore putOnboardingHintState(OnboardingHintState state) {
    ...
    @Override
    public SettingsStore clearOnboardingHintStates() {
    ...
    @Override
    public SettingsStore setNotificationActivitySetting(NotificationActivitySettingAction.NotificationActivitySetting setting) {
    ...
    @Override
    public SettingsStore setPrivateProcessingStatus(PrivateProcessingSettingAction.PrivateProcessingStatus status) {
    ...
    @Override
    public SettingsStore setNewsletterSubscriptionUserIdentifier(String identifier) {
    ...
    @Override
    public SettingsStore setNewsletterSavedInterests(String interests) {
    ...
    @Override
    public SettingsStore setStatusPostOptInNotificationPreferencesEnabled(Boolean enabled) {
    ...
    @Override
    public SettingsStore setChannelsPersonalisedRecommendationOptOut(Boolean optOut) {
    ...
    @Override
    public SettingsStore setStartAtLogin(boolean startAtLogin) {
        this.startAtLogin = startAtLogin;
        return this;
    }
    ...
    @Override
    public SettingsStore setMinimizeToTray(boolean minimizeToTray) {
        this.minimizeToTray = minimizeToTray;
        return this;
    }
    ...
    @Override
    public SettingsStore setReplaceTextWithEmoji(boolean replaceTextWithEmoji) {
        this.replaceTextWithEmoji = replaceTextWithEmoji;
        return this;
    }
    ...
    @Override
    public SettingsStore setBannerNotificationDisplayMode(SettingsSyncAction.DisplayMode mode) {
    ...
    @Override
    public SettingsStore setUnreadCounterBadgeDisplayMode(SettingsSyncAction.DisplayMode mode) {
    ...
    @Override
    public SettingsStore setMessagesNotificationEnabled(boolean enabled) {
    ...
    @Override
    public SettingsStore setCallsNotificationEnabled(boolean enabled) {
    ...
    @Override
    public SettingsStore setReactionsNotificationEnabled(boolean enabled) {
    ...
    @Override
    public SettingsStore setStatusReactionsNotificationEnabled(boolean enabled) {
    ...
    @Override
    public SettingsStore setTextPreviewForNotificationEnabled(boolean enabled) {
    ...
    @Override
    public SettingsStore setDefaultNotificationToneId(Integer toneId) {
    ...
    @Override
    public SettingsStore setGroupDefaultNotificationToneId(Integer toneId) {
    ...
    @Override
    public SettingsStore setAppTheme(AppTheme appTheme) {
        this.appTheme = appTheme;
        return this;
    }
    ...
    @Override
    public SettingsStore setWallpaperId(Integer wallpaperId) {
        this.wallpaperId = wallpaperId;
        return this;
    }
    ...
    @Override
    public SettingsStore setDoodleWallpaperEnabled(boolean enabled) {
    ...
    @Override
    public SettingsStore setFontSize(Integer fontSize) {
        this.fontSize = fontSize;
        return this;
    }
    ...
    @Override
    public SettingsStore setPhotosAutodownloadEnabled(boolean enabled) {
    ...
    @Override
    public SettingsStore setAudiosAutodownloadEnabled(boolean enabled) {
    ...
    @Override
    public SettingsStore setVideosAutodownloadEnabled(boolean enabled) {
    ...
    @Override
    public SettingsStore setDocumentsAutodownloadEnabled(boolean enabled) {
    ...
    @Override
    public SettingsStore setNotificationToneId(Integer toneId) {
    ...
    @Override
    public SettingsStore setMediaUploadQuality(SettingsSyncAction.MediaQualitySetting quality) {
    ...
    @Override
    public SettingsStore setSpellCheckEnabled(boolean enabled) {
    ...
    @Override
    public SettingsStore setEnterToSendEnabled(boolean enabled) {
    ...
    @Override
    public SettingsStore setGroupMessageNotificationEnabled(boolean enabled) {
    ...
    @Override
    public SettingsStore setGroupReactionsNotificationEnabled(boolean enabled) {
    ...
    @Override
    public SettingsStore setStatusNotificationEnabled(boolean enabled) {
    ...
    @Override
    public SettingsStore setStatusNotificationToneId(Integer toneId) {
    ...
    @Override
    public SettingsStore setPlaySoundForCallNotification(boolean enabled) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ProtobufSettingsStore that)) {
            return false;
        }
