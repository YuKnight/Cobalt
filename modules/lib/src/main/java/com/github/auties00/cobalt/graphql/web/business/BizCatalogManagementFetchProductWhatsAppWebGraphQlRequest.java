 ...
 * {@link BizCatalogManagementFetchProductWhatsAppWebGraphQlResponse}.
 *
 * @see BizCatalogManagementFetchProductWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizCatalogManagementFetchProductQuery")
public final class BizCatalogManagementFetchProductWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     *                                      omit the field
     */
    public BizCatalogManagementFetchProductWhatsAppWebGraphQlRequest(Jid jid, String productId, String width, String height, String fetchComplianceInfo, String directConnectionEncryptedInfo, String variantInfoFields, String variantThumbnailHeight, String variantThumbnailWidth) {
        this.jid = jid;
