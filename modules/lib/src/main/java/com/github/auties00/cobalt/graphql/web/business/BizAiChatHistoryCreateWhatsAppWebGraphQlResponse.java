 ...
 * {@link BizAiChatHistoryCreateWhatsAppWebGraphQlRequest} into a {@link BusinessAiMutationResult}.
 *
 ...
 *
 * @see BizAiChatHistoryCreateWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizAiChatHistoryCreateMutation")
public final class BizAiChatHistoryCreateWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private BizAiChatHistoryCreateWhatsAppWebGraphQlResponse(BusinessAiMutationResult result) {
        this.result = result;
    }
     ...
     */
    public static Optional<BizAiChatHistoryCreateWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        if (node == null) {
            return Optional.of(new BizAiChatHistoryCreateWhatsAppWebGraphQlResponse(null));
        }

        var result = new BusinessAiMutationResultBuilder()
                .success(Boolean.TRUE.equals(node.getBoolean("success")))
                .build();
        return Optional.of(new BizAiChatHistoryCreateWhatsAppWebGraphQlResponse(result));
    }
