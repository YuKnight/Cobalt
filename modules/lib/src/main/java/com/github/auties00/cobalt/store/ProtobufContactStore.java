...
/**
 * The protobuf-backed {@link ContactStore} holding this session's address-book and per-peer device state.
 *
 ...
 * account JID/LID through an {@link AccountStore} reference wired by the owning aggregate via
 * {@link #bindAccount(AccountStore)} after construction (the protobuf deserializer cannot pass a
 * sibling sub-store into this object's constructor).
 */
@ProtobufMessage
@SuppressWarnings({"unused", "UnusedReturnValue"})
public final class ProtobufContactStore implements ContactStore {
    /**
     ...
     */
    ProtobufContactStore(ConcurrentHashMap<Jid, Contact> contactsMap, ConcurrentHashMap<Jid, OutContact> outContactsMap, ConcurrentMap<Jid, BusinessVerifiedName> verifiedBusinessNamesMap) {
     ...
     */
    void bindAccount(AccountStore account) {
     ...
     */
    @Override
    public ContactStore addOutContact(OutContact outContact) {
    ...
    @Override
    public ContactStore clearOutContacts() {
     ...
     * (resolved through the bound {@link AccountStore}) and otherwise consults the LID-to-phone
     ...
     * belongs to the local account (resolved through the bound {@link AccountStore}), then consults
    ...
    @Override
    public ContactStore setBlocklistHash(String blocklistHash) {
    ...
    @Override
    public ContactStore setBlocklistMigrated(boolean blocklistMigrated) {
    ...
    @Override
    public ContactStore setReceivedBlocklistMigrationBefore1x1Migration(boolean value) {
    ...
    @Override
    public ContactStore setPrimaryDeviceCapabilities(DeviceCapabilities capabilities) {
    ...
    @Override
    public ContactStore putDeviceCapabilitiesEntry(DeviceCapabilitiesEntry entry) {
    ...
    @Override
    public ContactStore clearDeviceCapabilitiesStates() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ProtobufContactStore that)) {
            return false;
        }
