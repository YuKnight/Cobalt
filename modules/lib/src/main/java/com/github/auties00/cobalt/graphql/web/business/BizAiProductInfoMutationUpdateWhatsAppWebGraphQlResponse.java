 ...
 * {@link BizAiProductInfoMutationUpdateWhatsAppWebGraphQlRequest} into a {@link BusinessAiProductInfo}.
 *
 ...
 *
 * @see BizAiProductInfoMutationUpdateWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizAiProductInfoMutationUpdateMutation")
public final class BizAiProductInfoMutationUpdateWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private BizAiProductInfoMutationUpdateWhatsAppWebGraphQlResponse(BusinessAiProductInfo productInfo) {
     ...
     */
    public static Optional<BizAiProductInfoMutationUpdateWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        return Optional.of(new BizAiProductInfoMutationUpdateWhatsAppWebGraphQlResponse(productInfo));
    }
