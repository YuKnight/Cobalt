 ...
 * {@link BizCatalogManagementCreateCollectionWhatsAppWebGraphQlRequest} into a {@link BusinessProductCollection}.
 *
 ...
 *
 * @see BizCatalogManagementCreateCollectionWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizCatalogManagementCreateCollectionMutation")
public final class BizCatalogManagementCreateCollectionWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private BizCatalogManagementCreateCollectionWhatsAppWebGraphQlResponse(BusinessProductCollection collection) {
    ...
    public static Optional<BizCatalogManagementCreateCollectionWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        return Optional.of(new BizCatalogManagementCreateCollectionWhatsAppWebGraphQlResponse(collection));
    }
