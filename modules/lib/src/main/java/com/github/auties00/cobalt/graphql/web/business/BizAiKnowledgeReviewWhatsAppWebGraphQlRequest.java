 ...
 * reply is consumed through {@link BizAiKnowledgeReviewWhatsAppWebGraphQlResponse}.
 *
 * @see BizAiKnowledgeReviewWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizAiKnowledgeReviewQuery")
public final class BizAiKnowledgeReviewWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public BizAiKnowledgeReviewWhatsAppWebGraphQlRequest(Instant timestamp) {
