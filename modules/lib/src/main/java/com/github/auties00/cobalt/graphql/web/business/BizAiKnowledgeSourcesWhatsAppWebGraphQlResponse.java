 ...
 * {@link BizAiKnowledgeSourcesWhatsAppWebGraphQlRequest} into a {@link BusinessAiAgentHome}.
 *
 ...
 *
 * @see BizAiKnowledgeSourcesWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizAiKnowledgeSourcesQuery")
public final class BizAiKnowledgeSourcesWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private BizAiKnowledgeSourcesWhatsAppWebGraphQlResponse(BusinessAiAgentHome agentHome) {
     ...
     */
    public static Optional<BizAiKnowledgeSourcesWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        if (home == null) {
            return Optional.of(new BizAiKnowledgeSourcesWhatsAppWebGraphQlResponse(null));
        }
        ...
        var agentHome = new BusinessAiAgentHomeBuilder()
                ...
                .build();
        return Optional.of(new BizAiKnowledgeSourcesWhatsAppWebGraphQlResponse(agentHome));
    }
