 ...
 * {@link BizProfileAddressAutocompleteWhatsAppWebGraphQlRequest} into a list of {@link BusinessAddressSuggestion}.
 *
 ...
 * Cobalt domain model.
 *
 * @see BizProfileAddressAutocompleteWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizProfileAddressAutocompleteQuery")
public final class BizProfileAddressAutocompleteWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private BizProfileAddressAutocompleteWhatsAppWebGraphQlResponse(List<BusinessAddressSuggestion> suggestions) {
    ...
    public static Optional<BizProfileAddressAutocompleteWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        return Optional.of(new BizProfileAddressAutocompleteWhatsAppWebGraphQlResponse(suggestions));
    }
