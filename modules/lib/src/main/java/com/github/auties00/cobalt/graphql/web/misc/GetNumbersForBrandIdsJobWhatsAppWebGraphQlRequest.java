 ...
 * consumed through {@link GetNumbersForBrandIdsJobWhatsAppWebGraphQlResponse}.
 *
 * @see GetNumbersForBrandIdsJobWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebGetNumbersForBrandIdsJobQuery")
public final class GetNumbersForBrandIdsJobWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public GetNumbersForBrandIdsJobWhatsAppWebGraphQlRequest(List<String> brandIds, Boolean lidBasedResponse) {
