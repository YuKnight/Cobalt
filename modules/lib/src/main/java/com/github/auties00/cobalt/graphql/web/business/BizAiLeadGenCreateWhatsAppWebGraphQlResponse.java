 ...
 * {@link BizAiLeadGenCreateWhatsAppWebGraphQlRequest} into a {@link BusinessAiLeadGenForm}.
 *
 ...
 *
 * @see BizAiLeadGenCreateWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizAiLeadGenCreateMutation")
public final class BizAiLeadGenCreateWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     *             reported failure
     */
    private BizAiLeadGenCreateWhatsAppWebGraphQlResponse(BusinessAiLeadGenForm form) {
        this.form = form;
    }
     ...
     */
    public static Optional<BizAiLeadGenCreateWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        return Optional.of(new BizAiLeadGenCreateWhatsAppWebGraphQlResponse(form));
    }
