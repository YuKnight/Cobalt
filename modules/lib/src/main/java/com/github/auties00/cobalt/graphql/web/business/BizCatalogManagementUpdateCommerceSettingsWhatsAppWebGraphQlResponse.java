 ...
 * {@link BizCatalogManagementUpdateCommerceSettingsWhatsAppWebGraphQlRequest}.
 *
 ...
 *
 * @see BizCatalogManagementUpdateCommerceSettingsWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizCatalogManagementUpdateCommerceSettingsMutation")
public final class BizCatalogManagementUpdateCommerceSettingsWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private BizCatalogManagementUpdateCommerceSettingsWhatsAppWebGraphQlResponse(boolean cartEnabled) {
    ...
    public static Optional<BizCatalogManagementUpdateCommerceSettingsWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        return Optional.of(new BizCatalogManagementUpdateCommerceSettingsWhatsAppWebGraphQlResponse(cartEnabled));
    }
