 ...
 * {@link FetchNativeAdsMvpEligibilityWhatsAppWebGraphQlResponse}.
 *
 * @see FetchNativeAdsMvpEligibilityWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebFetchNativeAdsMvpEligibilityQuery")
public final class FetchNativeAdsMvpEligibilityWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     *                    variable
     */
    public FetchNativeAdsMvpEligibilityWhatsAppWebGraphQlRequest(String phoneNumber) {
