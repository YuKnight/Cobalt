 ...
 * consumed through {@link BizBroadcastBillingInfoWhatsAppWebGraphQlResponse}.
 *
 * @see BizBroadcastBillingInfoWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "useWAWebBizBroadcastBillingInfoQuery")
public final class BizBroadcastBillingInfoWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public BizBroadcastBillingInfoWhatsAppWebGraphQlRequest(String assetId, Long budget, String entrypoint) {
