 ...
 * reply is consumed through {@link BizCatalogManagementAppealProductWhatsAppWebGraphQlResponse}.
 *
 * @see BizCatalogManagementAppealProductWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizCatalogManagementAppealProductMutation")
public final class BizCatalogManagementAppealProductWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public BizCatalogManagementAppealProductWhatsAppWebGraphQlRequest(Jid jid, String productId, String reason) {
        this.jid = jid;
