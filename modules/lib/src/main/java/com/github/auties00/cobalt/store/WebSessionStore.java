...
public interface WebSessionStore {
     ...
     */
    WebSessionStore setFacebookGraphQlSession(CtwaAccessTokenSession facebookGraphQlSession);
     ...
     * @return this sub-store, for chaining
     */
    WebSessionStore setWhatsAppWebGraphQlSession(WhatsAppWebGraphQlSession whatsAppWebGraphQlSession);
}
