 ...
 * {@link BizGetProfileShimlinksWhatsAppWebGraphQlRequest} into a list of {@link BusinessWebsiteLink}.
 *
 ...
 *
 * @see BizGetProfileShimlinksWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizGetProfileShimlinksQuery")
public final class BizGetProfileShimlinksWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private BizGetProfileShimlinksWhatsAppWebGraphQlResponse(List<BusinessWebsiteLink> websites) {
    ...
    public static Optional<BizGetProfileShimlinksWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
            return Optional.empty();
        }
        var websites = parseWebsites(data.getJSONArray("xwa_whatsapp_smb_get_profile_linkshims"));
        return Optional.of(new BizGetProfileShimlinksWhatsAppWebGraphQlResponse(websites));
    }
