 ...
 * the reply is consumed through {@link BizCatalogManagementFetchCatalogWhatsAppWebGraphQlResponse}.
 *
 * @see BizCatalogManagementFetchCatalogWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizCatalogManagementFetchCatalogQuery")
public final class BizCatalogManagementFetchCatalogWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
