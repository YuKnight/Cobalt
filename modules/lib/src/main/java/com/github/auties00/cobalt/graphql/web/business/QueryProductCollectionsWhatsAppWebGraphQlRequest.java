 ...
 * {@link QueryProductCollectionsWhatsAppWebGraphQlResponse}.
 *
 * @see QueryProductCollectionsWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebQueryProductCollectionsQuery")
public final class QueryProductCollectionsWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     *                                      {@code null} when not requested
     */
    public QueryProductCollectionsWhatsAppWebGraphQlRequest(Jid bizJid, Integer collectionLimit, Integer itemLimit, String after,
