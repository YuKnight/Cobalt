 ...
 * {@link CreateWhatsAppAdsIdentityWhatsAppWebGraphQlRequest} into a {@link WhatsAppAdsIdentityPage}.
 *
 ...
 *
 * @see CreateWhatsAppAdsIdentityWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebCreateWhatsAppAdsIdentityMutation")
public final class CreateWhatsAppAdsIdentityWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private CreateWhatsAppAdsIdentityWhatsAppWebGraphQlResponse(WhatsAppAdsIdentityPage page) {
        this.page = page;
    }
     ...
     */
    public static Optional<CreateWhatsAppAdsIdentityWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        var page = new WhatsAppAdsIdentityPageBuilder()
                ...
                .build();
        return Optional.of(new CreateWhatsAppAdsIdentityWhatsAppWebGraphQlResponse(page));
    }
