...
import com.github.auties00.cobalt.graphql.web.WhatsAppWebGraphQlHttpSupport;
...
public final class WhatsAppWebGraphQlBootstrapClient {
    ...
    public boolean exchange(CanonicalCredentials credentials, String lsd) {
        ...
        JSONObject json;
        try {
            json = JSON.parseObject(WhatsAppWebGraphQlHttpSupport.stripXssiPrefix(response.body()));
    ...
    private static String encodeBody(CanonicalCredentials credentials, String lsd) {
        ...
        params.put("__user", "0");
        params.put("lsd", lsd);
        params.put("jazoest", WhatsAppWebGraphQlHttpSupport.jazoest(lsd));
