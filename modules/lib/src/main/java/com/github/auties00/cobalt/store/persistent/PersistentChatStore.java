...
import com.github.auties00.cobalt.store.ProtobufChatStore;
...
/**
 * The {@link ProtobufChatStore} variant that persists chat and newsletter metadata to {@code store.proto}
...
public final class PersistentChatStore extends ProtobufChatStore {
    /**
     ...
     */
    PersistentChatStore(List<Jid> favoriteChats, ConcurrentMap<Jid, ChatMute> mentionEveryoneMuteExpirationsMap, ConcurrentHashMap<Jid, PersistentChat> chats, ConcurrentHashMap<Jid, PersistentNewsletter> newsletters) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PersistentChatStore that)) {
            return false;
        }
