 ...
 * for that page. The reply is consumed through {@link ResolveAccountTypeAndAdPageQueryWhatsAppWebGraphQlResponse}.
 *
 * @see ResolveAccountTypeAndAdPageQueryWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebResolveAccountTypeAndAdPageQuery")
public final class ResolveAccountTypeAndAdPageQueryWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public ResolveAccountTypeAndAdPageQueryWhatsAppWebGraphQlRequest(String pageId) {
        this.pageId = pageId;
    }
