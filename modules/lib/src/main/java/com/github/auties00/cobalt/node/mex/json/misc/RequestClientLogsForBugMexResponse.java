...
public final class RequestClientLogsForBugMexResponse implements MexOperation.Response.Json {
    /**
    ...
    public static Optional<RequestClientLogsForBugMexResponse> of(Node node) {
