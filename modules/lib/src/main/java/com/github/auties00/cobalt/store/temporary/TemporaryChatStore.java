...
/**
 * The {@link ProtobufChatStore} variant that holds chats, newsletters and the status feed entirely in
...
public final class TemporaryChatStore extends ProtobufChatStore {
    /**
     ...
     */
    TemporaryChatStore(List<Jid> favoriteChats, ConcurrentMap<Jid, ChatMute> mentionEveryoneMuteExpirationsMap) {
