 ...
 * reply is consumed through {@link CreateMarketingCampaignActionWhatsAppWebGraphQlResponse}.
 *
 * @see CreateMarketingCampaignActionWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebCreateMarketingCampaignActionMutation")
public final class CreateMarketingCampaignActionWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public CreateMarketingCampaignActionWhatsAppWebGraphQlRequest(String adAccountId, String campaignName, String lifetimeBudget,
