...
/**
 * The persisted {@link WebSessionStore} implementation serialized inline with the aggregate store.
 *
...
@ProtobufMessage
public final class ProtobufWebSessionStore implements WebSessionStore {
    /**
     ...
     */
    ProtobufWebSessionStore(CtwaAccessTokenSession facebookGraphQlSession, WhatsAppWebGraphQlSession whatsAppWebGraphQlSession) {
    ...
    @Override
    public WebSessionStore setFacebookGraphQlSession(CtwaAccessTokenSession facebookGraphQlSession) {
        this.facebookGraphQlSession = facebookGraphQlSession;
        return this;
    }
    ...
    @Override
    public WebSessionStore setWhatsAppWebGraphQlSession(WhatsAppWebGraphQlSession whatsAppWebGraphQlSession) {
        this.whatsAppWebGraphQlSession = whatsAppWebGraphQlSession;
        return this;
    }
    ...
    public boolean equals(Object o) {
        return o == this || o instanceof ProtobufWebSessionStore that
