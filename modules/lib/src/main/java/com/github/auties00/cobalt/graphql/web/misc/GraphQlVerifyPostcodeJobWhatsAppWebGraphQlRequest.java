 ...
 * reply is consumed through {@link GraphQlVerifyPostcodeJobWhatsAppWebGraphQlResponse}.
 *
 * @see GraphQlVerifyPostcodeJobWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebGraphQLVerifyPostcodeJobQuery")
public final class GraphQlVerifyPostcodeJobWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     *                                      omit the field
     */
    public GraphQlVerifyPostcodeJobWhatsAppWebGraphQlRequest(Jid bizJid, String directConnectionEncryptedInfo) {
        this.bizJid = bizJid;
