 ...
 * {@link BizAiReplySettingsWhatsAppWebGraphQlRequest} into a {@link BusinessAiReplySettings}.
 *
 ...
 * model.
 *
 * @see BizAiReplySettingsWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizAiReplySettingsQuery")
public final class BizAiReplySettingsWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     *                      field
     */
    private BizAiReplySettingsWhatsAppWebGraphQlResponse(BusinessAiReplySettings replySettings) {
     ...
     */
    public static Optional<BizAiReplySettingsWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        if (trigger == null) {
            return Optional.of(new BizAiReplySettingsWhatsAppWebGraphQlResponse(null));
        }
        ...
        var replySettings = new BusinessAiReplySettingsBuilder()
                ...
                .build();
        return Optional.of(new BizAiReplySettingsWhatsAppWebGraphQlResponse(replySettings));
    }
