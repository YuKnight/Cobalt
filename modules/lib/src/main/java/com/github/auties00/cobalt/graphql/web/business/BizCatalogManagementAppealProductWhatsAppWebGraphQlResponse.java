 ...
 * {@link BizCatalogManagementAppealProductWhatsAppWebGraphQlRequest} into a {@link BusinessCatalogMutationResult}.
 *
 ...
 *
 * @see BizCatalogManagementAppealProductWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizCatalogManagementAppealProductMutation")
public final class BizCatalogManagementAppealProductWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private BizCatalogManagementAppealProductWhatsAppWebGraphQlResponse(BusinessCatalogMutationResult result) {
        this.result = result;
    }
    ...
    public static Optional<BizCatalogManagementAppealProductWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        var result = new BusinessCatalogMutationResultBuilder()
                ...
                .build();
        return Optional.of(new BizCatalogManagementAppealProductWhatsAppWebGraphQlResponse(result));
    }
