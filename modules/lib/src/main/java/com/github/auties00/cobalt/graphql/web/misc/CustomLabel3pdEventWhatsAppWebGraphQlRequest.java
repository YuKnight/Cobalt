 ...
 * {@link CustomLabel3pdEventWhatsAppWebGraphQlResponse}.
 *
 * @see CustomLabel3pdEventWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebCustomLabel3pdEventQuery")
public final class CustomLabel3pdEventWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     *                     the variable
     */
    public CustomLabel3pdEventWhatsAppWebGraphQlRequest(List<String> customLabels, String exptGroup) {
