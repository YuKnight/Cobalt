 ...
 *
 * <p>This abstract aggregate composes the domain sub-stores ({@link SignalStore}, {@link AccountStore},
 * {@link ContactStore}, {@link ChatStore}, {@link SyncStore}, {@link SettingsStore},
 * {@link BusinessStore}, {@link WebSessionStore}, {@link ConnectionStore}, {@link WamStore}) and
 ...
 * nested {@code MESSAGE} fields serialised inline with this aggregate ({@link BusinessStore} and
 * {@link ConnectionStore} are transient and never serialised).
 *
 * @implSpec
...
public abstract class ProtobufWhatsAppStore implements LinkedWhatsAppStore {
    ...
    private final ProtobufWamStore wamStore;
     ...
     */
    private final ProtobufConnectionStore connectionStore;
     ...
     */
    protected ProtobufWhatsAppStore(ProtobufSignalStore signalStore, ProtobufAccountStore accountStore, ProtobufContactStore contactStore, ProtobufSyncStore syncStore, ProtobufSettingsStore settingsStore, Path directory, ProtobufWebSessionStore webSessionStore, ProtobufWamStore wamStore) {
        ...
        this.wamStore = Objects.requireNonNullElseGet(wamStore, () -> new ProtobufWamStore(null));
        this.businessStore = new ProtobufBusinessStore();
        this.connectionStore = new ProtobufConnectionStore();
    ...
    @Override
    public ProtobufConnectionStore connectionStore() {
        return connectionStore;
    }

    @Override
    public ProtobufWamStore wamStore() {
        return wamStore;
    }
