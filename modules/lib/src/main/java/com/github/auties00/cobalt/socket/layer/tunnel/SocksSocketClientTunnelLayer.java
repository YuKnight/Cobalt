 ...
 */
final class SocksSocketClientTunnelLayer implements SocketClientTunnelLayer {
     ...
     */
    SocksSocketClientTunnelLayer(WhatsAppClientProxy.Socks proxy, SocketClientLayer<?> innerLayer) {
        this.proxy = proxy;
