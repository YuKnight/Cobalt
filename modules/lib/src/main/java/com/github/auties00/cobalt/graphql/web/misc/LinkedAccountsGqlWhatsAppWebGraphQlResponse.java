 ...
 * {@link LinkedAccountsGqlWhatsAppWebGraphQlRequest} into a {@link BusinessLinkedAdAccounts}.
 *
 ...
 *
 * @see LinkedAccountsGqlWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebLinkedAccountsGQLQuery")
public final class LinkedAccountsGqlWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     *                 field
     */
    private LinkedAccountsGqlWhatsAppWebGraphQlResponse(BusinessLinkedAdAccounts accounts) {
     ...
     *         object is missing
     */
    public static Optional<LinkedAccountsGqlWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        var accounts = new BusinessLinkedAdAccountsBuilder()
                ...
                .build();
        return Optional.of(new LinkedAccountsGqlWhatsAppWebGraphQlResponse(accounts));
    }
