 ...
 * {@link BizAiExampleResponseUpdateWhatsAppWebGraphQlRequest} into a {@link BusinessAiMutationResult}.
 *
 ...
 *
 * @see BizAiExampleResponseUpdateWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizAiExampleResponseUpdateMutation")
public final class BizAiExampleResponseUpdateWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private BizAiExampleResponseUpdateWhatsAppWebGraphQlResponse(BusinessAiMutationResult result) {
        this.result = result;
    }
    ...
    public static Optional<BizAiExampleResponseUpdateWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        if (node == null) {
            return Optional.of(new BizAiExampleResponseUpdateWhatsAppWebGraphQlResponse(null));
        }
        ...
        var result = new BusinessAiMutationResultBuilder()
                ...
                .build();
        return Optional.of(new BizAiExampleResponseUpdateWhatsAppWebGraphQlResponse(result));
    }
