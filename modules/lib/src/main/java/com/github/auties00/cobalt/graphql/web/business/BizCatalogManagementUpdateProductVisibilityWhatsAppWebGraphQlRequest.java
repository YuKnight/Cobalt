 ...
 * {@link BizCatalogManagementUpdateProductVisibilityWhatsAppWebGraphQlResponse}.
 *
 * @see BizCatalogManagementUpdateProductVisibilityWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizCatalogManagementUpdateProductVisibilityMutation")
public final class BizCatalogManagementUpdateProductVisibilityWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     *                 array
     */
    public BizCatalogManagementUpdateProductVisibilityWhatsAppWebGraphQlRequest(Jid jid, List<Product> products) {
        this.jid = jid;
