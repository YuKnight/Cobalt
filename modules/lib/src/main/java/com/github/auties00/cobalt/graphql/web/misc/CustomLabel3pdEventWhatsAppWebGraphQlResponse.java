 ...
 * {@link CustomLabel3pdEventWhatsAppWebGraphQlRequest} into a list of {@link CtwaConversionEvent}.
 *
 ...
 *
 * @see CustomLabel3pdEventWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebCustomLabel3pdEventQuery")
public final class CustomLabel3pdEventWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private CustomLabel3pdEventWhatsAppWebGraphQlResponse(List<CtwaConversionEvent> events) {
        this.events = events;
    }
     ...
     */
    public static Optional<CustomLabel3pdEventWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
            return Optional.empty();
        }

        var events = parseEvents(data.getJSONArray("xwa_get_3pd_event"));
        return Optional.of(new CustomLabel3pdEventWhatsAppWebGraphQlResponse(events));
    }
