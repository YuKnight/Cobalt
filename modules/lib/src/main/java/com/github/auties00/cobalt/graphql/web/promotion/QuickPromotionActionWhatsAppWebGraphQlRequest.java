 ...
 * {@link QuickPromotionActionWhatsAppWebGraphQlResponse}.
 *
 ...
 * epoch-seconds.
 *
 * @see QuickPromotionActionWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebQuickPromotionActionMutation")
public final class QuickPromotionActionWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public QuickPromotionActionWhatsAppWebGraphQlRequest(String event, String action, String promotionId, String surfaceNuxId, String promotionLoggingData, Instant clientTime) {
        this.event = event;
        this.action = action;
