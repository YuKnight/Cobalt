 ...
 * {@link BizGetCategoriesWhatsAppWebGraphQlResponse}.
 *
 * @see BizGetCategoriesWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizGetCategoriesQuery")
public final class BizGetCategoriesWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public BizGetCategoriesWhatsAppWebGraphQlRequest(String query, String locale) {
        this.query = query;
        this.locale = locale;
    }
