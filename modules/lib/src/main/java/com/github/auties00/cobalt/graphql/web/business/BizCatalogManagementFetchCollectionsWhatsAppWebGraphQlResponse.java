 ...
 * {@link BizCatalogManagementFetchCollectionsWhatsAppWebGraphQlRequest} into a {@link BusinessCatalogCollections}.
 *
 ...
 *
 * @see BizCatalogManagementFetchCollectionsWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizCatalogManagementFetchCollectionsQuery")
public final class BizCatalogManagementFetchCollectionsWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private BizCatalogManagementFetchCollectionsWhatsAppWebGraphQlResponse(BusinessCatalogCollections collections) {
    ...
    public static Optional<BizCatalogManagementFetchCollectionsWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        var page = new BusinessCatalogCollectionsBuilder()
                ...
                .afterCursor(after)
                .build();
        return Optional.of(new BizCatalogManagementFetchCollectionsWhatsAppWebGraphQlResponse(page));
    }
