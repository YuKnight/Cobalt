 ...
 * {@link BizAiProductInfoWhatsAppWebGraphQlRequest} into a {@link BusinessAiProductInfo}.
 *
 ...
 *
 * @see BizAiProductInfoWhatsAppWebGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizAiProductInfoMutation")
public final class BizAiProductInfoWhatsAppWebGraphQlResponse implements WhatsAppWebGraphQlOperation.Response {
    /**
     ...
     */
    private BizAiProductInfoWhatsAppWebGraphQlResponse(BusinessAiProductInfo productInfo) {
     ...
     */
    public static Optional<BizAiProductInfoWhatsAppWebGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        if (node == null || !Boolean.TRUE.equals(node.getBoolean("success"))) {
            return Optional.of(new BizAiProductInfoWhatsAppWebGraphQlResponse(null));
        }

        var productInfo = parseFirstProduct(node.getJSONArray("product_items"));
        return Optional.of(new BizAiProductInfoWhatsAppWebGraphQlResponse(productInfo));
    }
