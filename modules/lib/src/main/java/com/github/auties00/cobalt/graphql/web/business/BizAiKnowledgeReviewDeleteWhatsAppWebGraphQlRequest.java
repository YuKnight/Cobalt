 ...
 * {@link BizAiKnowledgeReviewDeleteWhatsAppWebGraphQlResponse}.
 *
 * @see BizAiKnowledgeReviewDeleteWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizAiKnowledgeReviewDeleteMutation")
public final class BizAiKnowledgeReviewDeleteWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public BizAiKnowledgeReviewDeleteWhatsAppWebGraphQlRequest(String id) {
        this.id = id;
    }
