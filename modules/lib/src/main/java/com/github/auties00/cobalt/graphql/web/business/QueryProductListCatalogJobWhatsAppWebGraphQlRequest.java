 ...
 * through {@link QueryProductListCatalogJobWhatsAppWebGraphQlResponse}.
 *
 * @see QueryProductListCatalogJobWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebQueryProductListCatalogJobQuery")
public final class QueryProductListCatalogJobWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     */
    public QueryProductListCatalogJobWhatsAppWebGraphQlRequest(Jid catalogJid, List<String> productIds, Integer width, Integer height, String directConnectionEncryptedInfo) {
