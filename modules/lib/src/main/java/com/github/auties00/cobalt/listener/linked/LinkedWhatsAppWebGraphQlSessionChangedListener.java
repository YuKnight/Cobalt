...
/**
 * A functional interface for the {@link LinkedWhatsAppClientListener#onWhatsAppWebGraphQlSessionChanged onWhatsAppWebGraphQlSessionChanged} event.
 *
 ...
 */
@FunctionalInterface
public non-sealed interface LinkedWhatsAppWebGraphQlSessionChangedListener extends WhatsAppLinkedListener {
    /**
     ...
     */
    void onWhatsAppWebGraphQlSessionChanged(LinkedWhatsAppClient whatsapp, WhatsAppWebGraphQlSession session);
}
