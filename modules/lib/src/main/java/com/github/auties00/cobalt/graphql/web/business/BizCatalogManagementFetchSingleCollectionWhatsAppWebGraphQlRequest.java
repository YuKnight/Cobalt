 ...
 * {@link BizCatalogManagementFetchSingleCollectionWhatsAppWebGraphQlResponse}.
 *
 * @see BizCatalogManagementFetchSingleCollectionWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizCatalogManagementFetchSingleCollectionQuery")
public final class BizCatalogManagementFetchSingleCollectionWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     *                                      omit the field
     */
    public BizCatalogManagementFetchSingleCollectionWhatsAppWebGraphQlRequest(Jid bizJid, String id, String limit, String after, String width, String height, String directConnectionEncryptedInfo, String variantInfoFields, String variantThumbnailHeight, String variantThumbnailWidth) {
        this.bizJid = bizJid;
        this.id = id;
        this.limit = limit;
        this.after = after;
