 ...
 * {@link WaaOnboardingWhatsAppWebGraphQlResponse}.
 *
 * @see WaaOnboardingWhatsAppWebGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebWAAOnboardingMutation")
public final class WaaOnboardingWhatsAppWebGraphQlRequest implements WhatsAppWebGraphQlOperation.Request {
    /**
     ...
     *                  field
     */
    public WaaOnboardingWhatsAppWebGraphQlRequest(String flowId, Instant requestId) {
        this.flowId = flowId;
