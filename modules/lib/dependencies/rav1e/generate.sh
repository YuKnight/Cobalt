#!/usr/bin/env bash
#
# Regenerates Java FFM bindings for rav1e (AV1 ENCODE only; calls2 video stack,
# package calls2.media.video.av1.bindings -- the SAME package as the dav1d decode
...
# functions the calls2 video stack uses, through fixed-width scalars and opaque
