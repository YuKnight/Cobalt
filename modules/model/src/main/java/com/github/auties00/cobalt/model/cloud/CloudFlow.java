 ...
 * the name, the lifecycle status ({@code DRAFT}, {@code PUBLISHED}, {@code DEPRECATED}), and the
 * declared categories.
 */
public final class CloudFlow {
     ...
     */
    public CloudFlow(String id, String name, String status, List<String> categories) {
        this.id = id;
     ...
     *
     * @return an {@link Optional} carrying the status, or empty before creation
     */
