 ...
 */
@ProtobufMessage(name = "SmbMeteredMessagingCheckout")
public final class SmbMeteredMessagingCheckout {
    /**
     * Mandatory cost breakdown for the campaign.
     */
    @ProtobufProperty(index = 1, type = ProtobufType.MESSAGE)
    SmbMeteredMessagingCost cost;
    ...
    SmbMeteredMessagingAccountBalance accountBalance;
    ...
    SmbMeteredMessagingQuota quota;
     ...
     */
    SmbMeteredMessagingCheckout(SmbMeteredMessagingCost cost,
                                boolean integrityEligible,
                                SmbMeteredMessagingAccountBalance accountBalance,
                                SmbMeteredMessagingQuota quota) {
        this.cost = cost;
     ...
     */
    public SmbMeteredMessagingCost cost() {
        return cost;
    }
     ...
     */
    public SmbMeteredMessagingAccountBalance accountBalance() {
     ...
     */
    public Optional<SmbMeteredMessagingQuota> quota() {
