 ...
 */
@ProtobufMessage(name = "SmbMeteredMessagingAccountBalance")
public final class SmbMeteredMessagingAccountBalance {
    /**
     ...
     */
    SmbMeteredMessagingAccountBalance(int billing, int available, int offset) {
