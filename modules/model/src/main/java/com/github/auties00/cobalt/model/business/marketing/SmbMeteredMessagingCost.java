 ...
 */
@ProtobufMessage(name = "SmbMeteredMessagingCost")
public final class SmbMeteredMessagingCost {
    /**
     ...
     *                                cost
     */
    SmbMeteredMessagingCost(int beforeTax, int tax, int offset, String currency,
