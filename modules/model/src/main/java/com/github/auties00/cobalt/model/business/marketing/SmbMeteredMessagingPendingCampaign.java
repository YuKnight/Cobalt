 ...
 */
@ProtobufMessage(name = "SmbMeteredMessagingPendingCampaign")
public final class SmbMeteredMessagingPendingCampaign {
    /**
     ...
     */
    SmbMeteredMessagingPendingCampaign(int freeReservedMsgs, Integer sendTimestamp) {
     ...
     */
    public static SmbMeteredMessagingPendingCampaign of(int freeReservedMsgs, Integer sendTimestamp) {
        return new SmbMeteredMessagingPendingCampaign(freeReservedMsgs, sendTimestamp);
    }
